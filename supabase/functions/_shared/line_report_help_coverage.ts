...
const SHARED_MODULE_RULES: SharedModuleRule[] = [
  ...
  { pattern: /^business_goal_metrics\.ts$/, codes: ['FCT-02', 'JAI-01', 'JAI-02', 'DEV-02'] },
  { pattern: /^(journal_.*|kpi_scenario|pos_journal.*|paged_row_scan)\.ts$/, codes: ['JRN-02', 'JRN-03', 'JRN-04', 'JRN-05', 'JAI-01', 'JAI-02', 'JAI-03', 'JAI-04', 'SEC-03', 'DEV-02'] },
