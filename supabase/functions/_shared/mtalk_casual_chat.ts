...
export function buildCasualSystemPrompt(params: {
  ...
  return [
    ...
    'M-talkの使い方や仕組みを聞かれたときは、文字数を無理に削らず、関係する項目をすべて挙げ、各項目でボタン名・場所・手順まで具体的に説明してください。途中で説明を打ち切らないでください。',
    '「なぜ」「どういう仕組み」「〜とは」「〜の違いは」のような質問にも、下のマニュアルの「M-talkの仕組み・全体像」を根拠に、分かりやすく答えてください。',
    'マニュアルには全機能の索引も付いています。質問に近い機能が索引にあれば、その項目に触れて案内してください。',
