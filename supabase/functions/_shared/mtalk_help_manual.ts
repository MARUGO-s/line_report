...
export const MTALK_HELP_SECTIONS: MtalkHelpSection[] = [
  ...
  },
  {
    ...
    content: [
      'メールアドレスとパスワードで新規登録します。初回に表示名・アイコン・所属店舗を決めます。所属店舗は必須で、複数選べます。そのあと、ルームの管理権限を持つ人が許可するまで使えません。許可の手続きは「管理者通知」ルームにだけ届き、予約通知や店舗ルームの一般メンバーには出ません。許可されると、選んだ所属で閲覧だけできる状態です。メッセージの送信やグループ作成は、管理者が後から権限を付けます。',
  ...
  },
  {
    ...
    content: [
      ...
      '新規登録は、ルームの管理権限を持つ人の許可が必要です。許可と不許可のカードは「管理者通知」ルームにだけ届き、予約通知や店舗ルームの一般メンバーには見えません。許可されると閲覧だけできる状態で始まります。送信やグループ作成は後から付けます。',
