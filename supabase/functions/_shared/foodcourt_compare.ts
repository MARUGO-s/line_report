...
export const FOODCOURT_ANALYSIS_AI_VERSION = 'foodcourt-analysis-ai-v32-generic-kpi-labels'
...
export const FOODCOURT_DAILY_ANALYSIS_AI_VERSION = 'foodcourt-analysis-ai-v32-generic-kpi-labels'
