...
export const FOODCOURT_ANALYSIS_AI_VERSION = 'foodcourt-analysis-ai-v31-capacity-table'
...
export const FOODCOURT_DAILY_ANALYSIS_AI_VERSION = 'foodcourt-analysis-ai-v31-capacity-table'
