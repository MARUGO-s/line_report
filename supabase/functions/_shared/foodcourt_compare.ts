...
export const FOODCOURT_ANALYSIS_AI_VERSION = 'foodcourt-analysis-ai-v24-kpi-process'
...
export const FOODCOURT_DAILY_ANALYSIS_AI_VERSION = 'foodcourt-analysis-ai-v24-kpi-process'
// 日次サマリーの「実効」キャッシュバージョン。品質ループは未設定時OFF（fail closed）。
// 現行では通常版・loop版とも v24 なので、ON/OFFによる不要なキャッシュ再生成は発生しない。
