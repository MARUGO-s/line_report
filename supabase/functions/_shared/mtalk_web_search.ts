...
const EXTERNAL_TOPIC_RE = new RegExp([
  ...
  'ワイン|品種|産地|ヴィンテージ|ビンテージ|銘柄|食材|旬',
  '他店|競合|同業',
  // 調理・提供の手順やコツ。飲食店のスタッフが実際に聞く中心的な話題なので、
  // 「レシピ」という語を使わない自然な言い回し（作り方・焼き方・仕込み）も拾う。
  'レシピ|作り方|つくり方|焼き方|茹で方|煮方|切り方|仕込み|下ごしらえ|保存方法|賞味期限',
  '料理|調理|ソース|パン|ケーキ|デザート|ペアリング|合わせる',
].join('|'), 'i')
