...
export const LINE_REPORT_HELP_SECTIONS: LineReportHelpSection[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      'web検索', 'ウェブ検索', 'ネット検索', '検索して答える', '出典', 'モデル', '料金',
    ],
    summary: '管理者設定、スタッフのセルフ設定、AIのWeb検索、ルーム削除範囲を説明する。',
    content: [
  ...
  },
  {
    ...
    keywords: [
      ...
      'カレンダー', 'イベント', '過去売上同期', 'ワイン', 'ml', 'グラス', 'デキャンタ', 'ボトル', 'ペアリング',
    ],
  ...
  },
  {
    ...
    code: 'KNW-02',
    categoryId: 'journal-knowledge',
    title: 'LINE #メモ・M-talkメニュー画像・添付資料登録',
    keywords: [
      '#メモ', '＃メモ', '#日報', '#note', 'lineメモ', '現場日報', '引用返信',
      '画像メモ', 'pdfメモ', '資料へ登録', '登録されない', 'm-talkメニュー',
      'メニュー画像', '登録する', '登録しない',
    ],
    summary: 'LINEやM-talkから店舗資料へ現場メモ・メニュー画像・添付を登録する方法を説明する。',
    content: [
  ...
  },
  {
    ...
    keywords: [
      ...
      'luna', 'claude', '東京ドーム', 'フードコート', 'marugo s',
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      'フードコート深掘り', 'ブースト', 'api料金', '専門ai', '統合分析',
    ],
  ...
  },
  {
    ...
    summary: '5方式の予測、改変不可の事前予測台帳、WAPE・MAE比較、14日予測を説明する。',
    content: [
...
export const LINE_REPORT_HELP_SECTION_SOURCES: Record<string, string[]> = {
  ...
  'KNW-02': [
    'public/chat.html',
    'supabase/functions/chat-knowledge/index.ts',
    'supabase/functions/_shared/chat_store_file_bridge.ts',
    'supabase/functions/_shared/mtalk_menu_knowledge.ts',
    'supabase/functions/line-webhook/index.ts',
  ...
  'FCT-02': [
    'supabase/functions/_shared/foodcourt_compare.ts',
    'supabase/functions/_shared/foodcourt_sales_context.ts',
    'supabase/functions/_shared/foodcourt_journal_detail.ts',
    'tests/foodcourt_journal_link.test.ts',
  ...
  'ADM-03': [
    'public/chat.html',
    'public/chat/permissions.js',
    'public/chat/rooms.js',
    'public/chat-admin.html',
    'supabase/functions/admin-api/index.ts',
