...
export const LINE_REPORT_HELP_SECTIONS: LineReportHelpSection[] = [
  ...
  },
  {
    ...
    summary: 'その日の精算レシート画像を売上へ登録する流れと対象外画像を説明する。',
    content: [
  ...
  {
    id: 'past-sales-bulk-import',
    code: 'SAL-07',
    categoryId: 'sales',
    title: '過去の売上をまとめて登録（Excel一括取込）',
    keywords: [
      '過去の売上', '過去売上', '過去の売上登録', '過去分', '過去', '一括取込', '一括',
      'まとめて登録', 'まとめて', 'さかのぼ', '遡', '前の月', '先月', '前月', '去年', '昨年',
      '日別売上管理表', '売上管理表', '売上テンプレート', '未入力', '後から登録', '昔の売上',
    ],
    summary: '過去の日次売上をExcel／CSVの一括取込で登録する2つの経路を説明する。',
    content: [
      ...
      'テンプレートが必要なときは、店舗LINEルームへ「日別売上管理表」「売上管理表テンプレート」等と送るとダウンロード用のカードが返ります。金額を入力して同じトークへ送り返します。',
