-- Keep the file-attachment normalization while retaining the existing mention
-- membership filter. This is a follow-up because 20260828010000 is deployed.
...
as $fn$
declare
  v_path text; v_w text; v_h text; v_sticker_id text; v_sticker_label text; v_sticker_path text;
