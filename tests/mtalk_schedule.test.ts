...
test("M-talk schedule page switches reservation and event tabs", async () => {
  ...
  assert.match(html, /tab === 'reservations'/)
  assert.match(html, /legendResv/)
  assert.match(html, /legendEvt/)
  assert.doesNotMatch(html, /tab === 'reservations' && !hasResv && hasEvt/)
  ...
  assert.match(api, /authenticateChatMember\(req, supabase, groupId, capability\)/)
  assert.match(api, /req\.method === "GET" \? "view" : "manage"/)
