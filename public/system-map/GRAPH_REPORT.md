...
## Summary
- 3970 nodes · 9404 edges · 330 communities (202 shown, 128 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 198 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a2b22586`
...
Cohesion: 0.03
Nodes (38): As(), beforeDatasetDraw(), beforeLayout(), d(), destroy(), Di(), es(), fe() (+30 more)
...
Cohesion: 0.07
Nodes (26): Ae(), afterDraw(), afterEvent(), afterUpdate(), at(), ba, Bi(), f() (+18 more)
...
Cohesion: 0.04
Nodes (18): beforeUpdate(), bn(), buildTicks(), ei(), go(), ii(), initialize(), je() (+10 more)
...
Cohesion: 0.06
Nodes (21): ca(), _calculateBarIndexPixels(), _calculateBarValuePixels(), Ci(), Do(), eo(), getBasePixel(), getLabelAndValue() (+13 more)
...
Cohesion: 0.07
Nodes (13): b(), buildLookupTable(), En, Fo(), _generate(), getDecimalForValue(), _getTimestampsForTable(), init() (+5 more)
...
Cohesion: 0.08
Nodes (8): Be(), jn, n(), ne(), numeric(), pi(), resolveDataElementOptions(), xo
...
Cohesion: 0.13
Nodes (6): bo, determineDataLimits(), getValueForPixel(), ko, vo(), wo()
...
- **Why does `xlsx` connect `Community 41` to `Community 114`, `Community 11`?**
  _High betweenness centrality (0.305) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 11` to `Community 41`, `Community 2`?**
  _High betweenness centrality (0.300) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 114` to `Community 41`, `Community 3`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.031211426556162936 - nodes in this community are weakly interconnected._
