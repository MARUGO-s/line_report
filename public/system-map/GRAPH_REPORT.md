...
## Summary
- 3970 nodes · 9404 edges · 332 communities (203 shown, 129 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 198 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f7b2353e`
...
1. `toSafeString()` - 67 edges
2. `an()` - 61 edges
3. `va` - 56 edges
4. `ns()` - 55 edges
5. `s()` - 53 edges
6. `normalizeInlineText()` - 51 edges
...
## Communities (332 total, 129 thin omitted)
...
Cohesion: 0.02
Nodes (80): addDaysIso(), AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, authenticate(), authenticateRawAdminToken(), backfillLineUserPermissionsFromMessages() (+72 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (47): As(), at(), beforeDatasetDraw(), buildTicks(), d(), destroy(), Di(), ei() (+39 more)
...
Cohesion: 0.05
Nodes (12): beforeUpdate(), bn(), go(), ii(), initialize(), ns(), parse(), pn() (+4 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (63): a(), aa(), ai(), ao(), average(), beforeDatasetsDraw(), beforeDraw(), cn() (+55 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (20): addBox(), addElements(), afterDatasetsUpdate(), an(), configure(), dt(), generateLabels(), Ie() (+12 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (22): Ae(), afterDraw(), afterEvent(), afterUpdate(), ba, Bi(), Ci(), f() (+14 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (69): applySheetMissingMonthDeletions(), BudgetComparable, budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, buildBudgetOperatingDaysSheetUpdates(), buildBudgetSheetRowUpdatesFromDb() (+61 more)
...
Cohesion: 0.08
Nodes (36): buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup(), buildReservationSummaryLookup(), chooseLaterIso(), chunkArray(), deleteChatPdfHistoryItem(), deleteDocumentById(), deleteMediaItemById() (+28 more)
...
Cohesion: 0.09
Nodes (39): analyzePosJournalWithAi(), asAppError(), buildLineUserPermissionPayload(), fetchManualMonthGross(), fetchManualMonthsForYearState(), fetchPosJournalAiHistory(), fetchPosJournalAiHistoryItem(), fetchPosJournalRows() (+31 more)
...
Cohesion: 0.07
Nodes (11): Be(), ca(), Do(), eo(), n(), ne(), numeric(), Oe() (+3 more)
...
Cohesion: 0.08
Nodes (18): _calculateBarIndexPixels(), _calculateBarValuePixels(), getBasePixel(), getLabelAndValue(), getLabelForValue(), getPixelForTick(), getPixelForValue(), _getRuler() (+10 more)
...
Cohesion: 0.17
Nodes (26): aggregateGroups(), aggregatePeriod(), boundedInteger(), boundedText(), buildPosJournalAiFacts(), callGroq(), ChatHistoryItem, groqUsage() (+18 more)
...
Cohesion: 0.07
Nodes (29): better-sqlite3, dotenv, express, dependencies, better-sqlite3, dotenv, express, xlsx (+21 more)
...
Cohesion: 0.14
Nodes (27): dedupeSalesSearchRows(), executeSalesSearch(), buildReceiptFlexMessage(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa(), formatYenOrDash(), kvRow() (+19 more)

### Community 44 - "Community 44"
Cohesion: 0.16
Nodes (26): applySauvageNetSalesAsGrossSales(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour(), formatJapaneseReceiptDateFromIso(), getJstBusinessDateForReceiptBudget() (+18 more)
...
Cohesion: 0.11
Nodes (12): ce(), ct(), de, fs(), ge(), gs(), he(), ms() (+4 more)
...
Cohesion: 0.16
Nodes (24): indexLineRoomReceiptSearch(), buildReceiptSummaryText(), isPlausibleReceiptCount(), looksLikeOcrLatinStoreLabel(), countFromRawOrDb(), currencyFromRawOrDb(), deleteReceiptSearchIndexEntries(), deleteReceiptSearchIndexForDate() (+16 more)
...
Cohesion: 0.15
Nodes (23): callKimi(), callOpenAiLuna(), ChatContent, contentsToOpenAiMessages(), corsHeaders, resolveKimiApiKey(), resolveKimiModel(), resolveOpenAiApiKey() (+15 more)
...
Cohesion: 0.18
Nodes (23): budgetRowStoreKeyIndex(), buildClosedDatesSheetUpdates(), buildSheetDeletionMergeContext(), collectBudgetMonthsOnSheet(), collectDailyDatesOnSheet(), collectPastMonthsOnSheet(), compressClosedDaysToSegments(), exportClosedDatesFromDbToBudgetSheet() (+15 more)

### Community 60 - "Community 60"
Cohesion: 0.17
Nodes (19): BUDGET_NOTICE_LINES, budgetConfirmFlex(), budgetDoneFlex(), budgetFlex(), CANCEL_WORDS, clearPending(), commitBudgetAndReply(), conversationKey() (+11 more)
...
Cohesion: 0.14
Nodes (21): buildDocumentStoragePath(), buildPosJournalStoragePath(), createPettyCashEntry(), createPettyCashEntryFromReceiptImage(), extractFileExt(), normalizePettyCashReceiptImageMime(), normalizePettyItems(), normalizePettyTaxMode() (+13 more)
...
Cohesion: 0.13
Nodes (4): bo, determineDataLimits(), getValueForPixel(), ko
...
Cohesion: 0.24
Nodes (9): buildStoreLocationPromptBlock(), getStoreLocationProfile(), MARUGO_GROUP_STORE_OPTIONS, STORE_COORDINATES, STORE_LOCATION_PROFILES, StoreLocationProfile, answerPosJournalAiQuestion(), factsJson() (+1 more)
...
Cohesion: 0.18
Nodes (8): askPosJournalAi(), buildDeterministicPosJournalAnalysis(), buildDeterministicPosJournalAnswer(), normalizePosJournalAiHistory(), normalizePosJournalAiQuestion(), pct(), yen(), expected
...
Cohesion: 0.25
Nodes (6): appThemePath, context, historyPath, htmlPath, indexPath, reports
...
Cohesion: 0.33
Nodes (4): buildPosJournalSummary(), sumDays(), crc16(), wrapLevel2Lh0()
...
## Knowledge Gaps
- **605 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+600 more)
...
- **Why does `xlsx` connect `Community 40` to `Community 10`, `Community 116`?**
  _High betweenness centrality (0.305) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 10` to `Community 40`, `Community 1`?**
  _High betweenness centrality (0.300) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 116` to `Community 40`, `Community 3`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.02378525314305131 - nodes in this community are weakly interconnected._