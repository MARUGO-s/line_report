...
## Summary
- 3844 nodes · 9168 edges · 316 communities (190 shown, 126 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 195 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `580915d7`
...
## Communities (316 total, 126 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (48): addBox(), average(), beforeDatasetDraw(), beforeDatasetsDraw(), Bt(), ct(), destroy(), es() (+40 more)
...
Cohesion: 0.06
Nodes (15): addElements(), afterDatasetsUpdate(), an(), configure(), fs(), generateLabels(), ke(), Mn() (+7 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (52): a(), aa(), ai(), ao(), beforeDraw(), cn(), da(), dataset() (+44 more)
...
Cohesion: 0.07
Nodes (18): Ae(), afterDraw(), afterEvent(), Bi(), Ci(), f(), gs(), ki() (+10 more)
...
Cohesion: 0.04
Nodes (32): Be(), bo, ca(), _calculateBarIndexPixels(), _calculateBarValuePixels(), determineDataLimits(), Do(), ea() (+24 more)
...
Cohesion: 0.07
Nodes (21): b(), ce(), de, dt(), g(), H(), he(), j() (+13 more)

### Community 22 - "Community 22"
Cohesion: 0.11
Nodes (40): buildCorrectionFlexHeader(), buildFieldSelectionPrompt(), buildReceiptCorrectionCancelOnlyFooter(), buildReceiptCorrectionConfirmCancelFooter(), buildUpdatedReceiptFlexReply(), buildValueInputPrompt(), clearPendingCorrection(), clearPendingReceiptCorrection() (+32 more)

### Community 23 - "Community 23"
Cohesion: 0.10
Nodes (49): indexLineRoomReceiptSearch(), normalizeReceiptCorrectionInputValue(), startCorrectionSession(), applySauvageNetSalesAsGrossSales(), buildReceiptSummaryText(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences() (+41 more)
...
Cohesion: 0.09
Nodes (12): color(), Ee(), Ft(), It(), kt(), Le(), mt(), qt() (+4 more)
...
Cohesion: 0.10
Nodes (10): bn(), ei(), je(), on(), pn(), qe(), ti(), un() (+2 more)
...
Cohesion: 0.17
Nodes (22): fetchJapaneseHolidaySet(), buildFoodcourtReportUri(), buildComparableEndDateForMonth(), buildReceiptAnalyticsDashboardUrlForLine(), computeBudgetDiffs(), computeComparableMonthProgressRatio(), DayAgg, dayOfMonthFromIso() (+14 more)

### Community 53 - "Community 53"
Cohesion: 0.12
Nodes (21): adjustProductStockQty(), adjustProductStockQtyTx, saveOcrResult(), buildCatalogChoiceLine(), clearLineSelectionState(), fetchLineImageBuffer(), formatCatalogPrimaryName(), formatCatalogSecondaryName() (+13 more)
...
Cohesion: 0.12
Nodes (21): attachAliases(), findCatalogProductsByPriceRange(), findCatalogProductsByQuery(), findCatalogProductsByVintage(), findCurrentPricesByQuery(), getActiveReplyTemplateByKey(), getPriceDistance(), renderTemplate() (+13 more)
...
Cohesion: 0.15
Nodes (10): buildMarugoGroupBuiltinPrompt(), buildMarugoSBuiltinPrompt(), EXPENSE_RECEIPT_PROMPT_ADDITION, EXPENSE_RECEIPT_PROMPT_CORE, EXPENSE_VENDOR_PROMPT_BLOCKS, ExpenseVendorPromptBlock, RECEIPT_VISION_SYSTEM_PROMPT_BASE, resolveBuiltinStoreReceiptPrompt() (+2 more)
...
- **Why does `xlsx` connect `Community 43` to `Community 3`, `Community 68`?**
  _High betweenness centrality (0.316) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 68` to `Community 2`, `Community 43`, `Community 15`?**
  _High betweenness centrality (0.312) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 3` to `Community 43`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.030096887239744383 - nodes in this community are weakly interconnected._
