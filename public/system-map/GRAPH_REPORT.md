...
## Summary
- 5518 nodes · 11844 edges · 536 communities (342 shown, 194 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `61c8b4cb`
...
## Communities (536 total, 194 thin omitted)
...
Cohesion: 0.06
Nodes (62): BudgetComparable, budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, buildClosedDatesExportFromDb(), buildDailySalesExportRows(), buildDailySeriesForStoreMonth() (+54 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (64): analyzePosJournalWithAi(), askPosJournalAi(), buildLineUserPermissionPayload(), fetchManualMonthsForYearState(), fetchPosJournalAiHistory(), fetchPosJournalAiHistoryItem(), fetchPosJournalCategoryOverrides(), fetchPosJournalCategoryRules() (+56 more)
...
Cohesion: 0.06
Nodes (62): analyzeStoreKnowledgeImage(), asAppError(), buildKnowledgeBodyFallback(), buildSavedReportHtmlStoragePath(), buildStoreKnowledgeSearchText(), callKnowledgeGemini(), chunkArray(), createSavedReportHtmlSignedUrl() (+54 more)
...
Cohesion: 0.10
Nodes (49): indexLineRoomReceiptSearch(), upsertManualDaySalesEntries(), startCorrectionSession(), buildReceiptSummaryText(), buildReceiptTextReply(), clamp01(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText() (+41 more)

### Community 17 - "Community 17"
Cohesion: 0.12
Nodes (38): isRecord(), applyProfileDictionaryClassification(), buildStoreReviewProfilePayload(), classifyNearbyWithAI(), compactGoogleRaw(), CompetitorPlaceRow, CompetitorSnapshotRow, expandCandidatesWithProfileGenreSearch() (+30 more)

### Community 18 - "Community 18"
Cohesion: 0.08
Nodes (47): buildHardcodedHolidayMap(), fetchCaoHolidayMap(), fetchJapaneseHolidayMap(), fetchJapaneseHolidaySet(), getJapaneseHolidayDateSet(), HolidayLiveCache, JAPANESE_HOLIDAY_ISO_DATES, JapaneseHolidaySource (+39 more)
...
Cohesion: 0.08
Nodes (47): addReservationDateDays(), assertReservationEventMatchesStoreScope(), buildCalendarVisitMonthLabel(), buildCalendarVisitTimeLabel(), buildJstMonthRange(), buildReservationCalendarItem(), buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup() (+39 more)
...
Cohesion: 0.08
Nodes (37): buildStoreLocationPromptBlock(), getStoreLocationProfile(), isMarugoGroupStoreLabel(), LABEL_SET, MARUGO_GROUP_STORE_OPTIONS, STORE_COORDINATES, STORE_LOCATION_PROFILES, StoreLocationProfile (+29 more)
...
Cohesion: 0.11
Nodes (36): FOOTER_COUNT_RETRY_STORE_KEYS, FORCE_RECEIPT_RETRY_STORE_KEYS, PRINTED_TIME_RETRY_STORE_KEYS, processReceiptImageEvent(), resolveClaudeApiKey(), ChatStoreBot, DbClient, menuKnowledgeFromLineImageAnalysis() (+28 more)
...
Cohesion: 0.10
Nodes (32): fetchAnalyticsMonthly(), fetchManualMonthsForYearState(), fetchReceiptDailyAggForRange(), fetchReceiptSalesState(), mergeSalesTotalsWithManualMonth(), sanitizeReceiptCountFromDb(), buildTrustedAiSalesData(), dateValid() (+24 more)
...
Cohesion: 0.09
Nodes (32): fetchDistinctRoomIdsFromRawTable(), fetchReceiptStoreOptions(), fetchReceiptWebhookStatus(), fetchSalesBudgetRow(), fetchStoreClosedDatesFromTable(), parsePositiveWeight(), ReceiptDailyAggRow, ReceiptSalesTotals (+24 more)
...
Cohesion: 0.15
Nodes (34): budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates(), buildBudgetSheetRowUpdatesFromDb(), buildClosedDatesSheetUpdates(), buildPastSalesSheetUpdatesFromDb(), buildSheetDeletionMergeContext(), collectBudgetMonthsOnSheet(), collectDailyDatesOnSheet() (+26 more)
...
Cohesion: 0.10
Nodes (32): buildDocumentStoragePath(), buildPosJournalRepairPayload(), buildPosJournalStoragePath(), createPettyCashEntry(), createPettyCashEntryFromReceiptImage(), deletePosJournalFile(), ensureJournalProductIndexMonths(), ensurePosJournalStorageForRepair() (+24 more)
...
Cohesion: 0.11
Nodes (31): addReceiptToCohort(), buildJournalProductIndexMonthSnapshot(), combineJournalProductDetailCoverage(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), emptyCohortBucket(), fetchChatPdfHistoryItem(), fetchChatPdfHistoryList() (+23 more)
...
Cohesion: 0.10
Nodes (29): appendChunkWithinLimit(), appendWordXmlNodeText(), buildDocumentSnippet(), collectTextNodes(), compareWordXmlEntry(), compareXlsxWorksheetEntry(), extractDocxText(), extractPdfText() (+21 more)

### Community 54 - "Community 54"
Cohesion: 0.12
Nodes (29): archiveChatMedia(), authenticateChatMember(), buildChatScheduleReservationDetail(), createManualReservationEvent(), deleteReservationEvent(), exchangeChatJournalLoginLink(), exchangeChatMediaViewLink(), fetchReservationEventRecordForScopeCheck() (+21 more)
...
Cohesion: 0.09
Nodes (28): clampInt(), createSignedMediaDownloadUrl(), fetchChatMediaView(), fetchDocumentPermissionSummaries(), fetchDocumentState(), fetchGlobalSettings(), fetchLineDocumentUsageStats(), fetchLineMediaUsageStats() (+20 more)
...
Cohesion: 0.17
Nodes (26): appendReceiptReportYoySection(), buildReceiptReportFlexMessages(), buildReceiptYoyCompactKvRows(), buildReceiptYoyKvRows(), calendarDaysInMonth(), countInclusiveCalendarDays(), flexBaselineRow(), flexBudgetRow() (+18 more)
...
Cohesion: 0.21
Nodes (25): dedupeSalesSearchRows(), executeSalesSearch(), buildReceiptChatCard(), buildReceiptFlexMessage(), field(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa() (+17 more)
...
Cohesion: 0.17
Nodes (22): postChatCard(), postStoreRoomLineStyleReply(), countExistingReceiptsForDates(), DailySalesParseResult, applyImport(), BotUser, dailySalesTemplateUrl(), DbClient (+14 more)
...
Cohesion: 0.14
Nodes (23): mtalkSyntheticRoomId(), DbClient, ensureMtalkRoomSettings(), loadMtalkRoomFlags(), MtalkRoomFlags, MtalkStoreBot, mtalkUserCanAccessStore(), resolveMtalkRoomStoreKey() (+15 more)
...
Cohesion: 0.12
Nodes (16): boundedStrings(), buildMtalkMenuKnowledgeCard(), MtalkMenuKnowledgeAnalysis, MtalkMenuKnowledgeItem, MtalkMenuKnowledgeStatus, normalizeMtalkMenuKnowledgeAnalysis(), parseMtalkMenuKnowledgeCommand(), text() (+8 more)
...
Cohesion: 0.16
Nodes (18): sendLinePushMessages(), sendLinePush(), buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken() (+10 more)
...
Cohesion: 0.17
Nodes (17): addDaysIso(), buildFoodcourtJournalCoverage(), FoodcourtJournalCoverage, FoodcourtJournalRange, inclusiveDayCount(), mergeRanges(), AppError, buildSnippet() (+9 more)
...
Cohesion: 0.12
Nodes (20): appendReservationHonorific(), buildGmailReservationAlertLinePayload(), buildGmailReservationAlertMessage(), buildGmailReservationChatCards(), buildGmailReservationFlexAltText(), buildGmailReservationFlexBubble(), buildGmailReservationFlexMessage(), buildGmailReservationFlexMessages() (+12 more)
...
Cohesion: 0.36
Nodes (9): fetchManualMonthSales(), buildReceiptReportAggregateFromRows(), loadReceiptReportAggregateForRoom(), loadReceiptReportAggregateForStoreByReceiptDate(), normalizeConfiguredStorePartitionKey(), receiptDateIsoFromValue(), ReceiptReportAggregate, resolveStorePartitionKeyForRoom() (+1 more)
...
Cohesion: 0.12
Nodes (20): buildRelaxedGmailAlertQuery(), buildReservationDetailLabel(), cleanupTestReservationSeed(), filterUnnotifiedGmailMessageIds(), markGmailAlertRoomSent(), maybeSendGmailReservationAlerts(), mergeUniqueGmailMessageLists(), pruneDeliveryLogs() (+12 more)
...
## Knowledge Gaps
- **1005 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+1000 more)
...
- **Why does `row()` connect `Community 41` to `Community 161`, `Community 162`, `Community 1`, `Community 35`, `Community 5`, `Community 2`, `Community 165`, `Community 130`, `Community 7`, `Community 42`, `Community 67`, `Community 14`, `Community 46`, `Community 113`, `Community 81`, `Community 51`, `Community 122`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `scanRowsByAscendingId()` connect `Community 130` to `Community 0`, `Community 41`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `buildFoodCourtDistillationRecords()` connect `Community 165` to `Community 0`, `Community 41`?**
