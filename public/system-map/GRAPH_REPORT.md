...
## Summary
- 3832 nodes · 9151 edges · 315 communities (192 shown, 123 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 194 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9966be19`
...
## Communities (315 total, 123 thin omitted)
...
Cohesion: 0.03
Nodes (72): addDaysIso(), AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, authenticate(), authenticateRawAdminToken(), backfillLineUserPermissionsFromMessages() (+64 more)
...
Cohesion: 0.06
Nodes (61): authenticateAdminDashboardSessionToken(), base64UrlEncode(), constantTimeEqualHex(), exchangeAdminDashboardLoginLinkToken(), exchangeRoomConfigLoginLink(), generateOpaqueToken(), hashRoomConfigPassword(), hashToken() (+53 more)
...
Cohesion: 0.07
Nodes (54): buildFlexInfoCard(), buildLineFlexBlueHeader(), flexButton(), FlexButtonAction, FlexButtonSpec, lineSafeFlexText(), ADMIN_MENU_POSTBACK, adminHelpButton() (+46 more)
...
Cohesion: 0.13
Nodes (34): buildCorrectionFlexHeader(), buildFieldSelectionPrompt(), buildReceiptCorrectionCancelOnlyFooter(), buildReceiptCorrectionConfirmCancelFooter(), buildUpdatedReceiptFlexReply(), buildValueInputPrompt(), clearPendingCorrection(), clearPendingReceiptCorrection() (+26 more)
...
Cohesion: 0.16
Nodes (30): handleStoreReceiptTextMessage(), normalizeReceiptCorrectionInputValue(), startCorrectionSession(), buildReceiptSummaryText(), formatYenAmount(), isPlausibleReceiptCount(), looksLikeOcrLatinStoreLabel(), parseCurrencyAmount() (+22 more)
...
Cohesion: 0.10
Nodes (32): asAppError(), buildLineUserPermissionPayload(), createSignedMediaUrl(), extractPdfText(), fetchLineMediaUsageStats(), fetchManualMonthGross(), fetchManualMonthsForYearState(), fetchMediaCountByStore() (+24 more)
...
Cohesion: 0.17
Nodes (21): amount(), buildPosJournalSummary(), firstInt(), FULLWIDTH_MAP, JournalRecord, normalizeWide(), parsePosJournalLzh(), parsePosJournalText() (+13 more)
...
Cohesion: 0.14
Nodes (25): executeSalesSearch(), buildReceiptFlexMessage(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa(), formatYenOrDash(), kvRow(), sectionTitle() (+17 more)
...
Cohesion: 0.10
Nodes (29): buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup(), buildReservationSummaryLookup(), chooseLaterIso(), chunkArray(), deleteDocumentById(), deleteMediaItemById(), ensureDocumentExists() (+21 more)
...
- **Why does `xlsx` connect `Community 43` to `Community 72`, `Community 105`?**
  _High betweenness centrality (0.316) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 72` to `Community 2`, `Community 43`, `Community 15`?**
  _High betweenness centrality (0.312) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 105` to `Community 43`, `Community 3`?**
