...
## Summary
- 4178 nodes · 9754 edges · 349 communities (210 shown, 139 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 197 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3f0d9b39`
...
## Communities (349 total, 139 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (57): afterUpdate(), ai(), average(), beforeDatasetDraw(), beforeDatasetsDraw(), beforeDraw(), d(), da() (+49 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (101): addDaysIso(), AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, authenticate(), authenticateRawAdminToken(), backfillLineUserPermissionsFromMessages() (+93 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (100): addPriceHistory(), addPriceTx, attachAliases(), buildProductWritePayload(), completeIngestionFile(), countIngestionErrorsByFileStmt, countIngestionProductSnapshotsByFileStmt, countPriceHistoryByIngestionFileStmt (+92 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (68): backupDatabaseTo(), getAdminTokenOverride(), app, asBackupTimestamp(), buildCatalogDetailLines(), buildCustomHeaderMap(), buildMarketPriceFromHints(), buildSearchQueryVariants() (+60 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (48): a(), aa(), ao(), b(), ba, cn(), dataset(), dn() (+40 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (71): buildLineUserPermissionPayload(), buildReservationSummaryLookup(), buildSavedReportHtmlStoragePath(), createSavedReportHtmlSignedUrl(), createSignedMediaUrl(), createStoreKnowledgeDownloadUrl(), deleteChatPdfHistoryItem(), deleteDocumentById() (+63 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (12): addBox(), addElements(), afterDatasetsUpdate(), an(), generateLabels(), ke(), Mn(), onClick() (+4 more)
...
Cohesion: 0.06
Nodes (14): at(), beforeUpdate(), _calculateBarValuePixels(), go(), ii(), initialize(), labelColor(), labelPointStyle() (+6 more)
...
Cohesion: 0.05
Nodes (17): beforeLayout(), bo, buildLookupTable(), configure(), En, et(), Fo(), _generate() (+9 more)
...
Cohesion: 0.04
Nodes (34): Be(), buildTicks(), ca(), _calculateBarIndexPixels(), determineDataLimits(), Do(), eo(), Fn() (+26 more)
...
Cohesion: 0.08
Nodes (51): addReservationDateDays(), asAppError(), assertReservationEventMatchesStoreScope(), buildCalendarVisitMonthLabel(), buildCalendarVisitTimeLabel(), buildJstMonthRange(), buildReservationCalendarItem(), buildReservationCountDedupeKey() (+43 more)
...
Cohesion: 0.13
Nodes (42): coerceMaybeJsonObject(), normalizeInlineText(), normalizeLineImageAnalysisResult(), parseFirstJsonObject(), salvageLineImageAnalysisResultFromText(), buildReceiptVisionSystemPrompt(), analyzeExpenseReceiptWithAzureFoundry(), analyzeExpenseReceiptWithGroqScout() (+34 more)
...
Cohesion: 0.05
Nodes (40): better-sqlite3, dotenv, express, dependencies, better-sqlite3, dotenv, express, xlsx (+32 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (14): Ae(), afterDraw(), afterEvent(), Bi(), Ci(), es(), f(), Fi() (+6 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (21): As(), bn(), Cs, e(), ei(), je(), label(), nn() (+13 more)
...
Cohesion: 0.18
Nodes (27): normalizeReceiptFieldText(), toReceiptStorePartitionKey(), alignReceiptStoreNameToRegistry(), findRegistryEntryForParsedStoreName(), normalizeStoreCompareKey(), receiptStoreNameMatchesRegistry(), resolveParsedStoreNameForDisplay(), StoreRegistryMatchCandidate (+19 more)
...
Cohesion: 0.13
Nodes (22): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), buildStoreKnowledgeSearchText(), callKnowledgeGemini(), deletePosJournalFile(), fetchStoreKnowledgeList(), generateStoreKnowledgeInsight(), json() (+14 more)
...
Cohesion: 0.15
Nodes (18): azureFoundryUsageFrom(), buildFoodCourtAckFlex(), buildFoodCourtDateConfirmFlex(), checkFoodCourtReceiptConsistency(), computeFoodCourtComparison(), extractFoodCourtTenants(), extractFoodCourtTenantsAzureFoundry(), fcMedian() (+10 more)
...
Cohesion: 0.17
Nodes (19): addReceiptToCohort(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), emptyCohortBucket(), filterFromProductSearchObject(), isWeekendBusinessDate(), itemMatchesPosProductFilter(), normalizeCohortComparisonSpec() (+11 more)
...
Cohesion: 0.17
Nodes (16): computeBudgetDiffs(), addCalendarDaysIso(), allocateDailyBudgetsForMonth(), classifySalesBudgetDay(), coerceStoreClosedDatesItems(), DayKind, DOW_TO_KIND, getDailyBudgetForDateFromAllocation() (+8 more)
...
Cohesion: 0.14
Nodes (10): buildMarugoGroupBuiltinPrompt(), buildMarugoSBuiltinPrompt(), combineStoreReceiptPromptAdditions(), EXPENSE_RECEIPT_PROMPT_ADDITION, EXPENSE_RECEIPT_PROMPT_CORE, EXPENSE_VENDOR_PROMPT_BLOCKS, ExpenseVendorPromptBlock, fetchStoreReceiptAnalysisPromptAddition() (+2 more)
...
Cohesion: 0.28
Nodes (10): buildJstMonthCreatedAtRange(), buildReceiptReportAggregateFromRows(), loadReceiptReportAggregateForRoom(), loadReceiptReportAggregateForStoreByReceiptDate(), loadReceiptRowsAnalyticsAligned(), normalizeConfiguredStorePartitionKey(), receiptDateIsoFromValue(), ReceiptReportAggregate (+2 more)
...
Cohesion: 0.47
Nodes (6): analyzePosJournalWithAi(), askPosJournalAi(), recordPosJournalAiUsage(), resolvePosJournalAiStore(), resolvePosJournalAiSummary(), savePosJournalAiAnalysis()

## Knowledge Gaps
- **662 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+657 more)
...
- **Why does `xlsx` connect `Community 24` to `Community 82`, `Community 3`?**
  _High betweenness centrality (0.273) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 82` to `Community 24`, `Community 1`, `Community 18`?**
  _High betweenness centrality (0.271) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 3` to `Community 24`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.02759835584263065 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.02039355992844365 - nodes in this community are weakly interconnected._