...
## Summary
- 5541 nodes · 12189 edges · 533 communities (342 shown, 191 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 104 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe7ea86e`
...
## Communities (533 total, 191 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (147): addDaysIso(), AdminAuthenticationResult, AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, applyChatAdminTemplate(), assertChatAdminAuditScope() (+139 more)
...
Cohesion: 0.06
Nodes (85): SheetValues, BudgetComparable, budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates() (+77 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (81): buildSavedReportHtmlStoragePath(), chunkArray(), createPettyCashEntry(), createSavedReportHtmlSignedUrl(), deleteChatPdfHistoryItem(), deleteDocumentById(), deleteMediaItemById(), deleteReportAiHistoryItem() (+73 more)
...
Cohesion: 0.07
Nodes (60): createPettyCashEntryFromReceiptImage(), recordPettyCashWebAiUsage(), buildDailySalesConfirmFlex(), buildDailySalesImportedFlex(), buildDailySalesSummaryRows(), buildDailySalesTemplateDownloadFlex(), buildReservationConfirmFlex(), buildReservationImportDetailJson() (+52 more)
...
Cohesion: 0.07
Nodes (58): pushLineMessages(), pushLineText(), buildFlexInfoCard(), buildLineFlexBlueHeader(), flexButton(), FlexButtonAction, FlexButtonSpec, lineSafeFlexText() (+50 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (55): addReceiptToCohort(), buildJournalProductIndexMonthSnapshot(), combineJournalProductDetailCoverage(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), emptyCohortBucket(), fetchChatPdfHistoryItem(), fetchChatPdfHistoryList() (+47 more)
...
Cohesion: 0.11
Nodes (44): clearBistrocavacavaSheetDataRowsAndPushFromDb(), base64UrlEncodeBytes(), base64UrlEncodeText(), fetchGoogleServiceAccountAccessToken(), pemToArrayBuffer(), signRs256(), addSpreadsheetSheet(), appendSpreadsheetValues() (+36 more)
...
Cohesion: 0.10
Nodes (39): fetchAnalyticsMonthly(), fetchDistinctRoomIdsFromRawTable(), fetchManualMonthsForYearState(), fetchReceiptDailyAggForRange(), fetchReceiptSalesState(), fetchReceiptStoreOptions(), fetchReceiptWebhookStatus(), fetchSalesBudgetRow() (+31 more)
...
Cohesion: 0.11
Nodes (45): indexLineRoomReceiptSearch(), upsertManualDaySalesEntries(), normalizeReceiptCorrectionInputValue(), applySauvageNetSalesAsGrossSales(), buildReceiptSummaryText(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences() (+37 more)
...
Cohesion: 0.12
Nodes (30): fetchManualDayBudgetMapForStore(), fetchManualDaySalesMapForStore(), manualDaySalesFromRow(), ManualDaySalesRecord, ManualDaySalesUpsertEntry, normalizeDateInput(), parseOptionalNonNegativeInt(), upsertManualDayBudgetEntries() (+22 more)

### Community 49 - "Community 49"
Cohesion: 0.10
Nodes (29): applyMention(), buildMessageNode(), clearReplyTarget(), closeMessageMenu(), closeReadDetails(), collectMentions(), currentMentionFragment(), fileFromMessage() (+21 more)
...
Cohesion: 0.18
Nodes (13): cancelMessageEdit(), closeForward(), copyMessage(), deleteMessage(), editableMessageText(), forwardToUser(), insertForwardedMessage(), messageCopyText() (+5 more)
...
Cohesion: 0.19
Nodes (20): postChatCard(), postStoreRoomLineStyleReply(), applyImport(), BotUser, dailySalesTemplateUrl(), DbClient, handleMtalkDailySalesCommand(), insertPendingImport() (+12 more)
...
Cohesion: 0.17
Nodes (20): purgeChatAdminRoom(), sendLinePushMessages(), resolveChatGroupId(), isMtalkSyntheticRoomId(), parseMtalkSyntheticRoomId(), assertIsolatedRoomId(), DbClient, deleteExact() (+12 more)
...
Cohesion: 0.18
Nodes (20): fetchJapaneseHolidaySet(), buildFoodcourtReportUri(), buildComparableEndDateForMonth(), buildReceiptAnalyticsDashboardUrlForLine(), computeComparableMonthProgressRatio(), DayAgg, dayOfMonthFromIso(), daysInMonth() (+12 more)
...
Cohesion: 0.18
Nodes (17): mtalkCardFromLineReply(), ChatStoreBot, DbClient, handleStoreRoomReceiptCommand(), loadChatStoreBot(), loadStoreRegistryRow(), mtalkMediaMessageId(), preferMenuKnowledgeResult() (+9 more)
...
Cohesion: 0.18
Nodes (16): saveSavedReport(), DailyTotals, EMPTY_RESULT, extractDailyTotalsFromReport(), isJournalSalesSyncEnabled(), isRecord(), JournalSalesSyncResult, normalizeDate() (+8 more)
...
Cohesion: 0.18
Nodes (17): fetchManualMonthSalesMapForStore(), manualMonthSalesFromRow(), ManualMonthSalesRecord, ManualMonthSalesUpsertEntry, normalizeSheetIntegerInput(), normalizeUpdatedAtInput(), parseManualMonthOperatingDays(), parseManualMonthPartyGuestFromUnknown() (+9 more)
...
Cohesion: 0.19
Nodes (15): ChatCardAction, ChatCardFieldRow, ChatCardListItem, ChatCardPayload, ChatCardSection, DbClient, dispatchChatPush(), emitFlexNote() (+7 more)
...
Cohesion: 0.15
Nodes (13): sendLinePushMessages(), buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken(), sendLinePush() (+5 more)
...
Cohesion: 0.15
Nodes (9): buildMarugoGroupBuiltinPrompt(), buildMarugoSBuiltinPrompt(), EXPENSE_RECEIPT_PROMPT_ADDITION, EXPENSE_RECEIPT_PROMPT_CORE, EXPENSE_VENDOR_PROMPT_BLOCKS, ExpenseVendorPromptBlock, RECEIPT_VISION_SYSTEM_PROMPT_BASE, resolveBuiltinStoreReceiptPrompt() (+1 more)
...
Cohesion: 0.09
Nodes (28): buildLineUserPermissionPayload(), clampInt(), createSignedMediaUrl(), fetchChatMediaView(), fetchGlobalSettings(), fetchLineMediaUsageStats(), fetchLineUserPermissions(), fetchMediaCountByStore() (+20 more)
...
Cohesion: 0.27
Nodes (9): resolveChannelAccessToken(), sanitizeLineToken(), buildReservationCalendarLinkFlex(), handleReservationCalendarLinkTextMessage(), TRIGGER_WORDS, buildRoomConfigUri(), handleRoomConfigTextMessage(), infoFlex() (+1 more)
...
## Knowledge Gaps
- **1007 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+1002 more)
...
- **Why does `row()` connect `Community 4` to `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 13`, `Community 14`, `Community 17`, `Community 18`, `Community 20`, `Community 152`, `Community 161`, `Community 34`, `Community 164`, `Community 39`, `Community 47`, `Community 51`, `Community 62`, `Community 67`, `Community 69`, `Community 87`, `Community 105`, `Community 116`, `Community 126`?**
  _High betweenness centrality (0.179) - this node is a cross-community bridge._
- **Why does `renderSheetPreview()` connect `Community 7` to `Community 4`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `roomHasStoreBot()` connect `Community 151` to `Community 41`, `Community 117`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.017647432235129816 - nodes in this community are weakly interconnected._
