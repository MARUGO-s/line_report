...
## Summary
- 3994 nodes · 9446 edges · 329 communities (200 shown, 129 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 198 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8397a493`
...
## Communities (329 total, 129 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (44): As(), beforeDatasetDraw(), beforeLayout(), buildTicks(), d(), destroy(), Di(), es() (+36 more)
...
Cohesion: 0.02
Nodes (79): addDaysIso(), AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, authenticate(), authenticateRawAdminToken(), backfillLineUserPermissionsFromMessages() (+71 more)
...
Cohesion: 0.07
Nodes (58): a(), aa(), ai(), ao(), average(), beforeDatasetsDraw(), beforeDraw(), cn() (+50 more)
...
Cohesion: 0.04
Nodes (19): beforeUpdate(), bn(), Ci(), ei(), go(), ii(), initialize(), je() (+11 more)
...
Cohesion: 0.11
Nodes (43): indexLineRoomReceiptSearch(), buildReceiptSummaryText(), buildReceiptTextReply(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour() (+35 more)
...
Cohesion: 0.09
Nodes (40): analyzePosJournalWithAi(), asAppError(), askPosJournalAi(), buildLineUserPermissionPayload(), deleteStoreKnowledgeItem(), fetchManualMonthGross(), fetchManualMonthsForYearState(), fetchPosJournalAiHistory() (+32 more)
...
Cohesion: 0.11
Nodes (36): getJapaneseHolidayDateSet(), buildFoodcourtReportUri(), buildComparableEndDateForMonth(), buildReceiptAnalyticsDashboardUrlForLine(), computeBudgetDiffs(), computeComparableMonthProgressRatio(), DayAgg, dayOfMonthFromIso() (+28 more)
...
Cohesion: 0.07
Nodes (38): buildStoreKnowledgeSearchText(), chunkArray(), createSignedMediaUrl(), createStoreKnowledgeDownloadUrl(), deleteChatPdfHistoryItem(), deleteDocumentById(), deleteMediaItemById(), deleteReportAiHistoryItem() (+30 more)
...
Cohesion: 0.10
Nodes (27): sendLinePush(), buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken(), sendLinePush() (+19 more)
...
Cohesion: 0.11
Nodes (33): buildPettyCashDashboardLink(), buildPettyCashPageUrl(), CANCEL_WORDS, classifyPettyAcct(), clearPending(), confirmFlex(), conversationKey(), defaultPettyRate() (+25 more)
...
Cohesion: 0.11
Nodes (28): buildCalendarVisitMonthLabel(), buildCalendarVisitTimeLabel(), buildJstMonthRange(), buildReservationCalendarItem(), buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup(), buildReservationNameSearchPatterns(), buildReservationSummaryLookup() (+20 more)
...
Cohesion: 0.16
Nodes (22): buildReceiptFlexMessage(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa(), formatYenOrDash(), kvRow(), sectionTitle(), valueColorForAchievementPct() (+14 more)
...
Cohesion: 0.19
Nodes (20): callKimi(), callKimiClarifier(), callOpenAiClarifier(), callOpenAiLuna(), ChatContent, ClarificationPlan, ClarifierProviderResult, clarifyWithFallback() (+12 more)
...
Cohesion: 0.25
Nodes (11): assertReservationEventMatchesStoreScope(), createManualReservationEvent(), deleteReservationEvent(), fetchReservationEventRecordForScopeCheck(), getReservationSummarySource(), normalizeReservationStoreScope(), normalizeReservationVisitAtIso(), rebuildReservationSummaryForCustomer() (+3 more)

### Community 99 - "Community 99"
Cohesion: 0.31
Nodes (10): callGrokTrendBrief(), callPerplexityBrief(), classifyJournalChatIntent(), ExternalBrief, fetchWithTimeout(), formatExternalBriefsForPrompt(), gatherExternalBriefs(), JournalChatIntent (+2 more)
...
## Knowledge Gaps
- **611 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+606 more)
...
- **Why does `xlsx` connect `Community 43` to `Community 113`, `Community 71`?**
  _High betweenness centrality (0.299) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 71` to `Community 2`, `Community 43`, `Community 13`?**
  _High betweenness centrality (0.295) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 113` to `Community 43`, `Community 3`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.02923538230884558 - nodes in this community are weakly interconnected._
