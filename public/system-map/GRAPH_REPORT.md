...
## Summary
- 3981 nodes · 9427 edges · 330 communities (201 shown, 129 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 198 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9ec52fc4`
...
## Communities (330 total, 129 thin omitted)
...
Cohesion: 0.03
Nodes (52): addBox(), As(), average(), beforeDatasetDraw(), beforeDatasetsDraw(), d(), dataset(), destroy() (+44 more)
...
Cohesion: 0.05
Nodes (26): Ae(), afterDraw(), afterEvent(), afterUpdate(), ba, Bi(), Ci(), Ee() (+18 more)
...
Cohesion: 0.04
Nodes (27): Be(), bo, ca(), _calculateBarIndexPixels(), _calculateBarValuePixels(), determineDataLimits(), Do(), eo() (+19 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (58): a(), aa(), ai(), ao(), at(), b(), beforeDraw(), cn() (+50 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (13): addElements(), afterDatasetsUpdate(), an(), configure(), generateLabels(), ke(), Mn(), onClick() (+5 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (69): buildLineFlexBlueHeader(), lineSafeFlexText(), buildAllFeaturesGuideFlex(), buildGroupSalesDatePromptFlex(), buildGroupSalesSearchGuideFlex(), buildGroupSalesSearchGuideText(), buildKindPromptFlex(), buildSearchEntryReply() (+61 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (67): BudgetComparable, budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, buildBudgetOperatingDaysSheetUpdates(), buildBudgetSheetRowUpdatesFromDb(), buildClosedDatesExportFromDb() (+59 more)

### Community 10 - "Community 10"
Cohesion: 0.11
Nodes (30): asAppError(), buildLineUserPermissionPayload(), fetchManualMonthGross(), fetchManualMonthsForYearState(), fetchPosJournalAiHistoryItem(), fetchSalesBudgetRow(), fetchSalesForecastsList(), fetchStorageUsageState() (+22 more)
...
Cohesion: 0.06
Nodes (12): beforeUpdate(), buildTicks(), go(), ii(), initialize(), labelColor(), labelPointStyle(), ns() (+4 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (17): beforeLayout(), buildLookupTable(), En, Fo(), _generate(), getDecimalForValue(), _getTimestampsForTable(), In() (+9 more)
...
Cohesion: 0.10
Nodes (28): processReceiptTextEvent(), buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken(), sendLinePush() (+20 more)
...
Cohesion: 0.12
Nodes (30): callKimi(), callKimiClarifier(), callOpenAiClarifier(), callOpenAiLuna(), ChatContent, ClarificationPlan, ClarifierProviderResult, clarifyWithFallback() (+22 more)
...
Cohesion: 0.10
Nodes (9): bn(), ei(), je(), pn(), qe(), qs(), ti(), xn (+1 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (59): assertReservationEventMatchesStoreScope(), buildCalendarVisitMonthLabel(), buildCalendarVisitTimeLabel(), buildJstMonthRange(), buildReservationCalendarItem(), buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup(), buildReservationNameSearchPatterns() (+51 more)
...
Cohesion: 0.14
Nodes (23): amount(), buildPosJournalSummary(), firstInt(), FULLWIDTH_MAP, JournalRecord, normalizeWide(), parsePosJournalLzh(), parsePosJournalText() (+15 more)
...
Cohesion: 0.14
Nodes (24): buildReceiptFlexMessage(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa(), formatYenOrDash(), kvRow(), sectionTitle(), valueColorForAchievementPct() (+16 more)
...
Cohesion: 0.18
Nodes (19): indexLineRoomReceiptSearch(), countFromRawOrDb(), currencyFromRawOrDb(), deleteReceiptSearchIndexEntries(), deleteReceiptSearchIndexForDate(), deleteReceiptsForDateByLineMessageIds(), deleteReceiptsForDateExcludingLineMessageId(), deleteStoreReceiptById() (+11 more)
...
Cohesion: 0.14
Nodes (18): analyzePosJournalWithAi(), askPosJournalAi(), fetchChatPdfHistoryItem(), fetchChatPdfHistoryList(), fetchPosJournalAiHistory(), fetchPosJournalRows(), fetchPosJournalState(), fetchReportAiHistoryList() (+10 more)
...
## Knowledge Gaps
- **610 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+605 more)
...
- **Why does `xlsx` connect `Community 42` to `Community 68`, `Community 117`?**
  _High betweenness centrality (0.304) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 68` to `Community 2`, `Community 18`, `Community 42`?**
  _High betweenness centrality (0.300) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 117` to `Community 42`, `Community 4`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.03137065637065637 - nodes in this community are weakly interconnected._