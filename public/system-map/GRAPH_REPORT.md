...
## Summary
- 5685 nodes · 12286 edges · 542 communities (348 shown, 194 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 116 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0df70528`
...
## Communities (542 total, 194 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (127): addDaysIso(), AdminAuthenticationResult, AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, authenticate(), AuthenticatedAdmin (+119 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (98): buildDailySalesConfirmFlex(), buildDailySalesImportedFlex(), buildDailySalesSummaryRows(), buildDailySalesTemplateDownloadFlex(), buildReservationConfirmFlex(), buildReservationImportDetailJson(), buildReservationRegisteredFlex(), buildReservationUpdatedFlex() (+90 more)
...
Cohesion: 0.04
Nodes (92): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), buildReservationSummaryLookup(), buildSavedReportHtmlStoragePath(), buildStoreKnowledgeSearchText(), callKnowledgeGemini(), chunkArray(), createSavedReportHtmlSignedUrl() (+84 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (80): upsertManualDaySalesEntries(), normalizeReceiptCorrectionInputValue(), startCorrectionSession(), buildReceiptDuplicateConfirmationFlexReply(), capText(), clearPendingReceiptDuplicate(), completePendingDuplicateAndReply(), conversationKey() (+72 more)
...
Cohesion: 0.07
Nodes (64): normalizeSheetIntegerInput(), applySheetMissingMonthDeletions(), BudgetComparable, budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, buildBudgetSheetRowUpdatesFromDb(), buildClosedDatesExportFromDb() (+56 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (67): pushLineMessages(), replyLineFlex(), resolveChannelAccessToken(), ensureLineRoomDisplayNameFromWebhook(), ensureLineUserDisplayNameFromWebhook(), fetchLineConversationNameByRoomId(), fetchLineConversationNameByUrl(), fetchLineDisplayNameByUrl() (+59 more)
...
Cohesion: 0.07
Nodes (66): aggregatePosJournalReceiptPayments(), allocateDayPaymentsToSales(), allocateDayTaxToSales(), amount(), buildJournalSavedReportHtml(), buildJournalSavedReportsFromPosDays(), buildPosJournalCategoryRules(), buildPosJournalDaysFromSavedReports() (+58 more)
...
Cohesion: 0.07
Nodes (57): getJapaneseHolidayDateSet(), JAPANESE_HOLIDAY_ISO_DATES, buildReceiptBudgetComparisonRows(), computeReceiptDailyDiffTotalLikeAnalyticsFooter(), fetchSalesBudgetRow(), formatYenAmount(), formatYenSignedDiff(), loadStoreDayGrossSumForDate() (+49 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (46): resolveGroqTextModel(), RETIRED_GROQ_TEXT_MODELS, ExtractedTokyoDomeEvent, extractEventTimes(), formatEventTimeLabel(), isWeekdayLabel(), markerCategory(), normalizeBaseballCategory() (+38 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (51): coerceMaybeJsonObject(), normalizeInlineText(), normalizeLineImageAnalysisResult(), normalizeLineImageMenuAnalysis(), parseFirstJsonObject(), salvageLineImageAnalysisResultFromText(), buildMarugoGroupBuiltinPrompt(), buildMarugoSBuiltinPrompt() (+43 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (54): addReservationDateDays(), asAppError(), assertReservationEventMatchesStoreScope(), buildCalendarVisitMonthLabel(), buildCalendarVisitTimeLabel(), buildChatScheduleReservationDetail(), buildJstMonthRange(), buildReservationCalendarItem() (+46 more)
...
Cohesion: 0.06
Nodes (43): ASSUMPTION_RULES, BASIS_RANK, buildDataGaps(), buildKpiScenarioPack(), computeScenario(), deriveKpiBaselineFromUnifiedSales(), emptyKpiBaseline(), FieldRule (+35 more)
...
Cohesion: 0.09
Nodes (39): buildStoreLocationPromptBlock(), aggregatePeriod(), answerPosJournalAiQuestion(), boundedInteger(), boundedSignedInteger(), boundedText(), buildDeterministicPosJournalAnalysis(), buildDeterministicPosJournalAnswer() (+31 more)
...
Cohesion: 0.09
Nodes (47): analyzePosJournalWithAi(), archiveChatMedia(), askPosJournalAi(), authenticateChatMember(), buildLineUserPermissionPayload(), deletePosJournalFile(), exchangeChatJournalLoginLink(), exchangeChatMediaViewLink() (+39 more)
...
Cohesion: 0.11
Nodes (37): fetchDistinctRoomIdsFromRawTable(), fetchManualMonthsForYearState(), fetchReceiptSalesState(), fetchReceiptStoreOptions(), fetchReceiptWebhookStatus(), fetchSalesBudgetRow(), fetchStoreClosedDatesFromTable(), mergeSalesTotalsWithManualMonth() (+29 more)
...
Cohesion: 0.10
Nodes (34): fetchAnalyticsMonthly(), fetchReceiptDailyAggForRange(), fetchManualDayBudgetMapForStore(), fetchManualDaySalesMapForStore(), manualDaySalesFromRow(), ManualDaySalesRecord, ManualDaySalesUpsertEntry, normalizeDateInput() (+26 more)
...
Cohesion: 0.12
Nodes (29): CORS_HEADERS, DbClient, filePayload(), handleDispatch(), imagePathFromPayload(), internalDispatchAuthorized(), isJournalArchiveName(), offerMenuKnowledgeRegistration() (+21 more)
...
Cohesion: 0.10
Nodes (32): buildDocumentStoragePath(), buildPosJournalRepairPayload(), buildPosJournalStoragePath(), createPettyCashEntry(), createPettyCashEntryFromReceiptImage(), ensureJournalProductIndexMonths(), ensurePosJournalStorageForRepair(), extractFileExt() (+24 more)

### Community 50 - "Community 50"
Cohesion: 0.09
Nodes (26): FoodCourtKpiContext, Loaders, prepareFoodCourtKpiScenario(), Profile, buildKpiScenarioReference(), isKpiScenarioRequest(), buildTrustedAiSalesData(), dateValid() (+18 more)

### Community 51 - "Community 51"
Cohesion: 0.15
Nodes (28): clearBistrocavacavaSheetDataRowsAndPushFromDb(), formatSheetA1Range(), appendSheetValuesForTab(), appendSyncLog(), exportBudgetFromDbToBudgetSheet(), exportClosedDatesFromDbToBudgetSheet(), exportPastSalesFromDbToPastSheet(), getSheetValuesForTab() (+20 more)
...
Cohesion: 0.20
Nodes (19): canonicalKeepStoreKey(), clearSpreadsheetTabsExceptStores(), clearStoreSheetBudgetTabsAndPushFromDb(), extractStoreKeyPrefixFromTabTitle(), isKeptStoreKey(), isStoreSalesDataTab(), resolveStoreKeyFromSheetTitle(), SKIP_SHEET_TITLES (+11 more)
...
Cohesion: 0.18
Nodes (21): buildJstDateStartUtcIso(), buildReceiptReportTestSchedule(), buildScheduleSliceForKind(), constantTimeEqual(), dispatchReceiptReport(), getJstMonthLastDay(), handleReceiptReportTestSend(), json() (+13 more)
...
Cohesion: 0.14
Nodes (14): ChatAction, CORS_HEADERS, helpCard(), SearchKind, ChatCard, emitFlexNote(), flexColor(), FlexField (+6 more)
...
Cohesion: 0.14
Nodes (31): parsePastSalesSheetRow(), budgetComparableEqual(), budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates(), buildSheetDeletionMergeContext(), collectBudgetMonthsOnSheet(), collectDailyDatesOnSheet(), collectPastMonthsOnSheet() (+23 more)
...
Cohesion: 0.17
Nodes (16): addName(), collectNames(), collectNamesFromText(), isRecord(), JournalAiPrivacyInput, JournalAiPrivacyResult, journalReservationAlias(), JsonRecord (+8 more)
...
Cohesion: 0.26
Nodes (14): handleDailySalesImportPostback(), clearDailyReceiptsForMonth(), DailySalesImportEntry, DailySalesParseResult, enumerateImportMonthDates(), importDailyReceiptsOverwrite(), importLooksLikeCsv(), importManualMonthSalesOverwrite() (+6 more)
...
Cohesion: 0.27
Nodes (13): RECEIPT_SHEETS_STORE_CATALOG, buildStoreReceiptPhoneIndex(), extractJapanesePhoneFromText(), listStorePhonesForPartitionKey(), normalizePhonesList(), normalizeReceiptPhoneDigits(), parseReceiptPhonesInput(), persistLearnedReceiptPhone() (+5 more)
...
Cohesion: 0.20
Nodes (10): ChatCardAction, ChatCardFieldRow, ChatCardListItem, ChatCardPayload, ChatCardSection, DbClient, dispatchChatPush(), postChatCardIndependent() (+2 more)
...
Cohesion: 0.38
Nodes (9): fetchManualMonthSales(), manualMonthSalesFromRow(), ManualMonthSalesRecord, ManualMonthSalesUpsertEntry, normalizeUpdatedAtInput(), parseManualMonthOperatingDays(), parseManualMonthPartyGuestFromUnknown(), parseOptionalNonNegativeInt() (+1 more)

### Community 147 - "Community 147"
Cohesion: 0.36
Nodes (8): boundedStrings(), buildMtalkMenuKnowledgeCard(), MtalkMenuKnowledgeAnalysis, MtalkMenuKnowledgeItem, MtalkMenuKnowledgeStatus, normalizeMtalkMenuKnowledgeAnalysis(), parseMtalkMenuKnowledgeCommand(), text()
...
Cohesion: 0.83
Nodes (3): nextTurn(), resolvePeriod(), wantsKpiTargets()
...
- **Why does `error()` connect `Community 153` to `Community 1`, `Community 3`, `Community 137`, `Community 10`, `Community 139`, `Community 12`, `Community 22`, `Community 28`, `Community 160`, `Community 163`, `Community 39`, `Community 40`, `Community 45`, `Community 56`, `Community 58`, `Community 69`, `Community 197`, `Community 74`, `Community 85`, `Community 97`, `Community 107`, `Community 111`, `Community 112`, `Community 120`?**
  _High betweenness centrality (0.206) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 107` to `Community 0`, `Community 1`, `Community 71`, `Community 151`, `Community 153`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `generatePosJournalAiAnalysis()` connect `Community 22` to `Community 0`, `Community 153`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.01683375729462816 - nodes in this community are weakly interconnected._
