...
## Summary
- 5509 nodes · 11996 edges · 525 communities (333 shown, 192 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 99 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e42618a7`
...
10. `answerFoodCourtQuestion()` - 31 edges
...
## Communities (525 total, 192 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (134): addDaysIso(), AdminAuthenticationResult, AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, AuthenticatedAdmin, authenticateRawAdminToken() (+126 more)
...
Cohesion: 0.05
Nodes (100): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), buildSavedReportHtmlStoragePath(), buildStoreKnowledgeSearchText(), callKnowledgeGemini(), chunkArray(), createSavedReportHtmlSignedUrl(), createSignedMediaUrl() (+92 more)
...
Cohesion: 0.04
Nodes (87): azureFoundryUsageFrom(), buildDailyLogsContext(), buildFoodCourtCompareFlex(), buildFoodCourtProviderOrder(), buildLoopFeedback(), claudeChat(), claudeUsageFrom(), evaluateFoodCourtAnswer() (+79 more)
...
Cohesion: 0.08
Nodes (70): buildGroupSalesDatePromptFlex(), buildGroupSalesSearchGuideFlex(), buildGroupSalesSearchGuideText(), buildKindPromptFlex(), buildSearchEntryReply(), buildSearchMenuFlex(), buildSearchMenuFooter(), clearSearchPending() (+62 more)
...
Cohesion: 0.06
Nodes (48): fetchPosJournalCategoryRules(), amount(), buildPosJournalCategoryRules(), classifyPosJournalDrinkSubclassByName(), classifyPosJournalReportItem(), CodeSpec, codeSpecMatches(), firstInt() (+40 more)
...
Cohesion: 0.06
Nodes (54): addReceiptToCohort(), buildJournalProductIndexMonthSnapshot(), combineJournalProductDetailCoverage(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), emptyCohortBucket(), fetchChatPdfHistoryItem(), fetchChatPdfHistoryList() (+46 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (43): createPettyCashEntryFromReceiptImage(), processReceiptImageEvent(), ChatStoreBot, DbClient, menuKnowledgeFromLineImageAnalysis(), mtalkMediaMessageId(), preferMenuKnowledgeResult(), processStoreRoomImageLikeLine() (+35 more)
...
Cohesion: 0.11
Nodes (53): isRecord(), roundToScale(), toSafeString(), applyProfileDictionaryClassification(), buildReviewExcerpt(), buildStoreReviewProfilePayload(), classifyNearbyWithAI(), compactGoogleRaw() (+45 more)

### Community 18 - "Community 18"
Cohesion: 0.10
Nodes (42): analyzePosJournalWithAi(), askPosJournalAi(), recordPosJournalAiUsage(), resolvePosJournalAiSummary(), buildStoreLocationPromptBlock(), aggregateGroups(), aggregatePeriod(), answerPosJournalAiQuestion() (+34 more)
...
Cohesion: 0.10
Nodes (45): base64UrlEncodeBytes(), base64UrlEncodeText(), fetchGoogleServiceAccountAccessToken(), pemToArrayBuffer(), signRs256(), addSpreadsheetSheet(), appendSpreadsheetValues(), batchUpdateSpreadsheetValues() (+37 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (43): archiveChatMedia(), authenticate(), authenticateChatMember(), exchangeChatJournalLoginLink(), exchangeChatMediaViewLink(), handleChatRoomConfig(), handleChatRoomPurge(), handleChatScheduleEvent() (+35 more)

### Community 23 - "Community 23"
Cohesion: 0.10
Nodes (42): buildFoodcourtReportUri(), buildReceiptTextReply(), clamp01(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour(), formatJapaneseReceiptDateFromIso(), getJstBusinessDateForReceiptBudget() (+34 more)
...
Cohesion: 0.08
Nodes (21): read(), root, read(), root, read(), root, read(), root (+13 more)
...
Cohesion: 0.07
Nodes (36): buildDocumentSnippet(), buildLineUserPermissionPayload(), clampInt(), createSignedMediaDownloadUrl(), fetchChatMediaView(), fetchDocumentPermissionSummaries(), fetchDocumentState(), fetchGlobalSettings() (+28 more)
...
Cohesion: 0.10
Nodes (31): fetchDistinctRoomIdsFromRawTable(), fetchReceiptWebhookStatus(), fetchSalesBudgetRow(), fetchStoreClosedDatesFromTable(), parsePositiveWeight(), ReceiptDailyAggRow, ReceiptSalesTotals, ReceiptStoreOptionRow (+23 more)

### Community 41 - "Community 41"
Cohesion: 0.09
Nodes (33): buildHardcodedHolidayMap(), fetchCaoHolidayMap(), fetchJapaneseHolidayMap(), fetchJapaneseHolidaySet(), getJapaneseHolidayDateSet(), HolidayLiveCache, JAPANESE_HOLIDAY_ISO_DATES, JapaneseHolidaySource (+25 more)
...
Cohesion: 0.08
Nodes (51): upsertManualDaySalesEntries(), startCorrectionSession(), buildReceiptDuplicateConfirmationFlexReply(), capText(), clearPendingReceiptDuplicate(), completePendingDuplicateAndReply(), conversationKey(), formatJapaneseReceiptDateFromIso() (+43 more)
...
Cohesion: 0.12
Nodes (27): fetchAnalyticsMonthly(), fetchManualMonthsForYearState(), fetchReceiptDailyAggForRange(), fetchReceiptSalesState(), mergeSalesTotalsWithManualMonth(), ManualDaySalesRecord, loadMonthAggUpToDate(), buildDailySeriesForStoreMonth() (+19 more)
...
Cohesion: 0.13
Nodes (27): buildFoodCourtWeeklyReportLink(), issueAdminDashboardLoginLinkToken(), BUDGET_NOTICE_LINES, budgetConfirmFlex(), budgetDoneFlex(), budgetFlex(), CANCEL_WORDS, clearPending() (+19 more)
...
Cohesion: 0.11
Nodes (30): buildPosJournalRepairPayload(), buildPosJournalStoragePath(), deletePosJournalFile(), ensureJournalProductIndexMonths(), ensurePosJournalStorageForRepair(), extractFileExt(), fetchPosJournalAiHistory(), fetchPosJournalCategoryOverrides() (+22 more)
...
Cohesion: 0.17
Nodes (21): ascii(), BitReader, crc16(), decodeBitLengthDecoder(), decodeDistanceLengths(), decodeLh5(), decodeLiteralLengths(), decodeUnary7() (+13 more)
...
Cohesion: 0.14
Nodes (20): sendLinePushMessages(), buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken(), sendLinePush() (+12 more)
...
Cohesion: 0.08
Nodes (22): chat, migration, root, chat, migration, singleReactionMigration, chat, chatSource (+14 more)
...
Cohesion: 0.21
Nodes (18): purgeChatAdminRoom(), isMtalkSyntheticRoomId(), mtalkSyntheticRoomId(), assertIsolatedRoomId(), DbClient, deleteExact(), dropRoomMessageTable(), isMissingRelation() (+10 more)

### Community 92 - "Community 92"
Cohesion: 0.22
Nodes (21): upsertPosJournalAutoReports(), aggregatePosJournalReceiptPayments(), allocateDayPaymentsToSales(), allocateDayTaxToSales(), buildJournalSavedReportHtml(), buildJournalSavedReportsFromPosDays(), buildPosJournalDaysFromSavedReports(), dateRangeLabel() (+13 more)
...
Cohesion: 0.15
Nodes (17): buildFoodCourtAckFlex(), buildFoodCourtDashboardLink(), buildFoodCourtDateConfirmFlex(), buildFoodCourtPageUrl(), checkFoodCourtReceiptConsistency(), computeFoodCourtComparison(), fcAddDays(), fcMedian() (+9 more)
...
Cohesion: 0.24
Nodes (11): fillPosJournalDaysWeather(), posJournalMonthBounds(), applyCachedWeatherToPosJournalDays(), applyPosJournalCategoryOverrides(), buildPosJournalSummary(), isPosJournalAdjustmentItem(), parsePosJournalTempC(), posJournalDayNeedsWeather() (+3 more)
...
Cohesion: 0.33
Nodes (11): buildReceiptReportAggregateFromRows(), loadReceiptReportAggregateForRoom(), loadReceiptReportAggregateForStoreByReceiptDate(), normalizeConfiguredStorePartitionKey(), receiptDateIsoFromValue(), ReceiptReportAggregate, resolveStorePartitionKeyForRoom(), toReceiptStorePartitionKey() (+3 more)
...
Cohesion: 0.27
Nodes (9): cleanupUploadedKnowledgeFile(), registerQuotedImageAsKnowledge(), extensionForKind(), jsonResponse(), LineEvent, resolveAdminChannelSecret(), serveAdminApprovalWebhook(), verifyLineSignature() (+1 more)
...
Cohesion: 0.50
Nodes (7): fetchManualDayBudgetMapForStore(), fetchManualDaySalesMapForStore(), manualDaySalesFromRow(), ManualDaySalesUpsertEntry, normalizeDateInput(), parseOptionalNonNegativeInt(), upsertManualDayBudgetEntries()
...
Cohesion: 0.38
Nodes (7): appendReceiptSheetsBackgroundSyncSummaryLog(), runReceiptSheetsPilotSync(), runReceiptSheetsPilotSyncChainedStep(), runWithConcurrencyLimit(), scheduleReceiptSheetsSyncContinue(), summarizeStoreSyncError(), invalidateSpreadsheetTitleCache()
...
## Knowledge Gaps
- **1003 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+998 more)
...
- **Why does `row()` connect `Community 5` to `Community 1`, `Community 2`, `Community 3`, `Community 134`, `Community 7`, `Community 13`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 153`, `Community 154`, `Community 156`, `Community 38`, `Community 52`, `Community 55`, `Community 71`, `Community 77`, `Community 92`, `Community 105`, `Community 114`, `Community 125`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 88` to `Community 0`, `Community 16`, `Community 77`, `Community 144`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `xlsx` connect `Community 144` to `Community 88`, `Community 121`, `Community 146`?**
