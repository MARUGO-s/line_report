...
## Summary
- 5064 nodes · 11029 edges · 484 communities (303 shown, 181 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `79823b48`
...
## Communities (484 total, 181 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (131): addDaysIso(), AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, applyChatAdminTemplate(), authenticate(), authenticateRawAdminToken() (+123 more)
...
Cohesion: 0.05
Nodes (86): ChatAction, CORS_HEADERS, helpCard(), SearchKind, emitFlexNote(), flexColor(), FlexField, flexNoteSize() (+78 more)
...
Cohesion: 0.05
Nodes (77): buildDisplayWidthIndent(), buildGmailReservationAlertLinePayload(), buildGmailReservationAlertMessage(), buildGmailReservationChatCards(), buildRelaxedGmailAlertQuery(), buildReservationCalendarUrlsForAlerts(), buildReservationHistoryParagraphs(), cleanupTestReservationSeed() (+69 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (50): addReceiptToCohort(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), emptyCohortBucket(), fetchChatPdfHistoryItem(), fetchChatPdfHistoryList(), fetchReportAiHistoryList(), fetchSalesForecastItem() (+42 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (62): buildJstMonthCreatedAtRange(), buildReceiptReportAggregateFromRows(), loadReceiptReportAggregateForRoom(), loadReceiptReportAggregateForStoreByReceiptDate(), loadReceiptRowsAnalyticsAligned(), normalizeConfiguredStorePartitionKey(), receiptDateIsoFromValue(), ReceiptReportAggregate (+54 more)
...
Cohesion: 0.05
Nodes (77): assertReservationEventMatchesStoreScope(), buildCalendarVisitMonthLabel(), buildCalendarVisitTimeLabel(), buildChatScheduleReservationDetail(), buildReservationCalendarItem(), buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup(), buildReservationNameSearchPatterns() (+69 more)
...
Cohesion: 0.08
Nodes (54): appendReservationHonorific(), buildGmailReservationFlexAltText(), buildGmailReservationFlexBubble(), buildGmailReservationFlexMessage(), buildGmailReservationFlexMessages(), buildGmailReservationFlexParagraphRow(), buildGmailReservationFlexRow(), buildReservationDetailLabel() (+46 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (52): buildDailyLogsContext(), buildFoodCourtCompareFlex(), buildLoopFeedback(), EXTRACT_PROMPT, FC_CODE_TO_NAME, FC_DOW, FC_NAME_ALIASES, fcApplyFlagName() (+44 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (53): allocateDayPaymentsToSales(), allocateDayTaxToSales(), applyCachedWeatherToPosJournalDays(), applyPosJournalCategoryOverrides(), buildJournalSavedReportHtml(), buildJournalSavedReportsFromPosDays(), buildPosJournalDaysFromSavedReports(), buildPosJournalSummary() (+45 more)
...
Cohesion: 0.10
Nodes (38): askPosJournalAi(), buildStoreLocationPromptBlock(), aggregateGroups(), aggregatePeriod(), answerPosJournalAiQuestion(), boundedInteger(), boundedText(), buildDeterministicPosJournalAnalysis() (+30 more)

### Community 24 - "Community 24"
Cohesion: 0.12
Nodes (43): coerceMaybeJsonObject(), normalizeInlineText(), normalizeLineImageAnalysisResult(), parseFirstJsonObject(), parseModelReceiptConfidence(), salvageLineImageAnalysisResultFromText(), buildReceiptVisionSystemPrompt(), analyzeExpenseReceiptWithAzureFoundry() (+35 more)

### Community 25 - "Community 25"
Cohesion: 0.08
Nodes (43): BudgetComparable, budgetComparableFromSheetRow(), BudgetRow, buildClosedDatesExportFromDb(), buildDailySeriesForStoreMonth(), buildJstDateKeysForMonth(), buildNextMonthFirstDateKey(), closedOnToMonthDateIso() (+35 more)

### Community 26 - "Community 26"
Cohesion: 0.11
Nodes (36): importDailyReceiptsCommit(), parseManualDaySalesImport(), buildSimpleNoticeFlex(), handleDailySalesImportPostback(), processDailySalesFileEvent(), postChatCard(), clearDailyReceiptsForMonth(), countExistingReceiptsForDates() (+28 more)

### Community 27 - "Community 27"
Cohesion: 0.10
Nodes (38): allergyLabel(), buildReservationRow(), buildTodayReservationCalendarUrl(), buildTodayReservationChatCard(), buildTodayReservationChatText(), buildTodayReservationFlex(), DbClient, formatReservationCustomerName() (+30 more)
...
Cohesion: 0.07
Nodes (59): createPettyCashEntryFromReceiptImage(), buildDailySalesConfirmFlex(), buildDailySalesImportedFlex(), buildDailySalesSummaryRows(), buildDailySalesTemplateDownloadFlex(), buildReservationConfirmFlex(), buildReservationImportDetailJson(), buildReservationRegisteredFlex() (+51 more)
...
Cohesion: 0.10
Nodes (38): formatSheetA1Range(), appendReceiptSheetsBackgroundSyncSummaryLog(), appendSheetValuesForTab(), appendSyncLog(), buildDailySalesExportRows(), compressClosedDaysToSegments(), exportBudgetFromDbToBudgetSheet(), exportClosedDatesFromDbToBudgetSheet() (+30 more)
...
Cohesion: 0.09
Nodes (34): evaluateFoodCourtAnswer(), foodCourtEvalDeadlineAt(), parseLoopEvaluationJson(), recordFoodCourtFallbackEvent(), recordFoodCourtFallbackIfNeeded(), assessFoodCourtEvolutionReadiness(), auditFoodCourtAnswerNumbers(), buildFoodCourtFallbackEvent() (+26 more)
...
Cohesion: 0.07
Nodes (22): read(), root, read(), root, read(), root, read(), root (+14 more)

### Community 42 - "Community 42"
Cohesion: 0.15
Nodes (20): fetchManualMonthGross(), fetchManualMonthsForYearState(), fetchSalesBudgetRow(), fetchSalesForecastsList(), fetchStorageUsageState(), fetchStoreClosedDatesFromTable(), listCalendarMonthsInclusive(), normalizeBudgetStoreKey() (+12 more)
...
Cohesion: 0.07
Nodes (25): chat, migration, root, chat, migration, singleReactionMigration, chat, chat (+17 more)
...
Cohesion: 0.14
Nodes (18): sendLinePushMessages(), buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken(), sendLinePush() (+10 more)

### Community 48 - "Community 48"
Cohesion: 0.15
Nodes (30): indexLineRoomReceiptSearch(), startCorrectionSession(), buildReceiptSummaryText(), isPlausibleReceiptCount(), looksLikeOcrLatinStoreLabel(), parseCurrencyAmount(), parseIntegerCount(), resolveCanonicalStoreDisplayName() (+22 more)

### Community 49 - "Community 49"
Cohesion: 0.22
Nodes (18): archiveChatMedia(), authenticateChatMember(), buildJstMonthRange(), handleChatRoomConfig(), handleChatRoomPurge(), handleChatSchedule(), handleChatScheduleEvent(), issueChatJournalLoginLink() (+10 more)
...
Cohesion: 0.12
Nodes (30): fetchManualMonthSalesMapForStore(), manualMonthSalesFromRow(), ManualMonthSalesRecord, ManualMonthSalesUpsertEntry, normalizeSheetIntegerInput(), normalizeUpdatedAtInput(), parseManualMonthOperatingDays(), parseManualMonthPartyGuestFromUnknown() (+22 more)
...
Cohesion: 0.11
Nodes (27): purgeChatAdminRoom(), ChatCard, ChatCardAction, ChatCardFieldRow, ChatCardListItem, ChatCardPayload, ChatCardSection, DbClient (+19 more)
...
Cohesion: 0.13
Nodes (25): buildFoodCourtWeeklyReportLink(), issueAdminDashboardLoginLinkToken(), BUDGET_NOTICE_LINES, budgetConfirmFlex(), budgetDoneFlex(), budgetFlex(), CANCEL_WORDS, clearPending() (+17 more)
...
Cohesion: 0.09
Nodes (29): analyzePosJournalWithAi(), buildPosJournalRepairPayload(), buildPosJournalStoragePath(), deletePosJournalFile(), ensureJournalProductIndexMonths(), ensurePosJournalStorageForRepair(), extractFileExt(), fetchPosJournalAiHistory() (+21 more)
...
Cohesion: 0.23
Nodes (22): buildReceiptChatCard(), buildReceiptFlexMessage(), field(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa(), formatYenOrDash(), kvRow() (+14 more)
...
Cohesion: 0.21
Nodes (19): buildReceiptTextReply(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour(), formatJapaneseReceiptDateFromIso(), getJstBusinessDateForReceiptBudget(), isSingleDayPeriodSettlementReport(), normalizeLineImageReceiptAnalysis() (+11 more)
...
Cohesion: 0.19
Nodes (19): fetchJapaneseHolidaySet(), buildFoodcourtReportUri(), buildComparableEndDateForMonth(), buildReceiptAnalyticsDashboardUrlForLine(), computeComparableMonthProgressRatio(), DayAgg, dayOfMonthFromIso(), daysInMonth() (+11 more)
...
Cohesion: 0.42
Nodes (10): toSafeString(), deactivateCompetitorPlace(), deactivateStoreReviewPlace(), ensureStoreReviewProfile(), fetchCompetitorReviewContext(), fetchStoreReviewContext(), fetchStoreReviewPlaceAndLatest(), resolveAnalyticsStoreKey() (+2 more)
...
Cohesion: 0.12
Nodes (31): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), buildStoreKnowledgeSearchText(), callKnowledgeGemini(), createStoreKnowledgeDownloadUrl(), deleteStoreKnowledgeItem(), fetchStoreKnowledgeItem(), fetchStoreKnowledgeItems() (+23 more)
...
## Knowledge Gaps
- **907 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+902 more)
...
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 26` to `Community 0`, `Community 21`, `Community 29`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `xlsx` connect `Community 21` to `Community 105`, `Community 26`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 105` to `Community 3`, `Community 21`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _907 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.017546583850931677 - nodes in this community are weakly interconnected._
