...
## Summary
- 4094 nodes · 9593 edges · 331 communities (197 shown, 134 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 197 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `84f107e4`
...
## Communities (331 total, 134 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (44): addBox(), beforeDatasetDraw(), beforeDatasetsDraw(), bo, buildTicks(), d(), destroy(), determineDataLimits() (+36 more)
...
Cohesion: 0.07
Nodes (17): Ae(), afterDraw(), afterEvent(), afterUpdate(), ba, Bi(), f(), ki() (+9 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (57): a(), aa(), ai(), ao(), average(), beforeDraw(), cn(), da() (+49 more)
...
Cohesion: 0.04
Nodes (22): at(), beforeUpdate(), bn(), Ci(), ei(), go(), ii(), initialize() (+14 more)
...
Cohesion: 0.08
Nodes (53): coerceMaybeJsonObject(), normalizeInlineText(), normalizeLineImageAnalysisResult(), parseFirstJsonObject(), salvageLineImageAnalysisResultFromText(), buildMarugoGroupBuiltinPrompt(), buildMarugoSBuiltinPrompt(), buildReceiptVisionSystemPrompt() (+45 more)
...
Cohesion: 0.09
Nodes (54): indexLineRoomReceiptSearch(), applySauvageNetSalesAsGrossSales(), buildReceiptSummaryText(), buildReceiptTextReply(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText() (+46 more)
...
Cohesion: 0.05
Nodes (27): Be(), ca(), _calculateBarIndexPixels(), _calculateBarValuePixels(), Do(), eo(), getBasePixel(), getLabelAndValue() (+19 more)
...
Cohesion: 0.09
Nodes (42): allergyLabel(), buildReservationRow(), buildTodayReservationCalendarUrl(), buildTodayReservationFlex(), DbClient, formatReservationCustomerName(), formatTargetMonth(), handleTestSend() (+34 more)
...
Cohesion: 0.05
Nodes (42): better-sqlite3, dotenv, express, dependencies, better-sqlite3, dotenv, express, xlsx (+34 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (52): addReceiptToCohort(), analyzePosJournalWithAi(), asAppError(), askPosJournalAi(), buildLineUserPermissionPayload(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), emptyCohortBucket() (+44 more)
...
Cohesion: 0.09
Nodes (41): fetchJapaneseHolidaySet(), buildReceiptFlexMessage(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa(), formatYenOrDash(), kvRow(), sectionTitle() (+33 more)
...
Cohesion: 0.09
Nodes (8): As(), Cs, getMaxOverflow(), nn(), os(), size(), sn, xt
...
Cohesion: 0.12
Nodes (34): buildPettyCashDashboardLink(), buildPettyCashPageUrl(), CANCEL_WORDS, classifyPettyAcct(), clearPending(), confirmFlex(), conversationKey(), defaultPettyRate() (+26 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (28): b(), ce(), ct(), de, dt(), fs(), g(), ge() (+20 more)

### Community 41 - "Community 41"
Cohesion: 0.10
Nodes (26): buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken(), sendLinePush(), SPORT_ICON (+18 more)
...
Cohesion: 0.11
Nodes (27): deleteStoreKnowledgeItem(), fetchLineMediaUsageStats(), fetchManualMonthGross(), fetchManualMonthsForYearState(), fetchMediaCountByStore(), fetchMediaState(), fetchSalesBudgetRow(), fetchSenderNameMapForUserIds() (+19 more)

### Community 49 - "Community 49"
Cohesion: 0.11
Nodes (23): buildHardcodedHolidayMap(), fetchCaoHolidayMap(), fetchJapaneseHolidayMap(), getJapaneseHolidayDateSet(), HolidayLiveCache, JAPANESE_HOLIDAY_ISO_DATES, JapaneseHolidaySource, mergeWithFutureFallback() (+15 more)
...
Cohesion: 0.08
Nodes (37): buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup(), buildReservationSummaryLookup(), buildSavedReportHtmlStoragePath(), chooseLaterIso(), chunkArray(), createSavedReportHtmlSignedUrl(), createSignedMediaUrl() (+29 more)
...
Cohesion: 0.16
Nodes (22): BUDGET_NOTICE_LINES, budgetConfirmFlex(), budgetDoneFlex(), budgetFlex(), CANCEL_WORDS, clearPending(), commitBudgetAndReply(), conversationKey() (+14 more)
...
- **Why does `xlsx` connect `Community 22` to `Community 81`, `Community 110`?**
  _High betweenness centrality (0.300) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 81` to `Community 1`, `Community 18`, `Community 22`?**
  _High betweenness centrality (0.298) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 110` to `Community 3`, `Community 22`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.02796143250688705 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.021333333333333333 - nodes in this community are weakly interconnected._