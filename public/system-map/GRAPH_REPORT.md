...
## Summary
- 5184 nodes · 11182 edges · 506 communities (323 shown, 183 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6fb23ed3`
...
6. `handleDispatch()` - 32 edges
7. `answerFoodCourtQuestion()` - 31 edges
8. `processPullRowsToDb()` - 31 edges
9. `generateFoodCourtDailySummary()` - 30 edges
...
## Communities (506 total, 183 thin omitted)
...
Cohesion: 0.06
Nodes (91): BudgetComparable, budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates(), buildBudgetSheetRowUpdatesFromDb() (+83 more)
...
Cohesion: 0.06
Nodes (58): buildDailySalesConfirmFlex(), buildDailySalesImportedFlex(), buildDailySalesSummaryRows(), buildDailySalesTemplateDownloadFlex(), buildReservationConfirmFlex(), buildReservationImportDetailJson(), buildReservationRegisteredFlex(), buildReservationUpdatedFlex() (+50 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (55): bearerToken(), constantTimeEqual(), CORS_HEADERS, isAuthorized(), isServiceRoleAuthorized(), clearBistrocavacavaSheetDataRowsAndPushFromDb(), canonicalKeepStoreKey(), clearSpreadsheetTabsExceptStores() (+47 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (92): addReceiptToCohort(), analyzePosJournalWithAi(), askPosJournalAi(), buildLineUserPermissionPayload(), buildSavedReportHtmlStoragePath(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), createSavedReportHtmlSignedUrl() (+84 more)
...
Cohesion: 0.20
Nodes (18): archiveChatMedia(), authenticateChatMember(), callKnowledgeGemini(), exchangeChatJournalLoginLink(), exchangeChatMediaViewLink(), handleChatRoomConfig(), handleChatRoomPurge(), handleChatScheduleEvent() (+10 more)
...
Cohesion: 0.09
Nodes (43): allocateDayPaymentsToSales(), allocateDayTaxToSales(), buildJournalSavedReportHtml(), buildJournalSavedReportsFromPosDays(), buildPosJournalDaysFromSavedReports(), classifyPosJournalReportItem(), dateRangeLabel(), FULLWIDTH_MAP (+35 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (44): better-sqlite3, dotenv, express, dependencies, better-sqlite3, dotenv, express, xlsx (+36 more)
...
Cohesion: 0.10
Nodes (39): buildStoreLocationPromptBlock(), aggregateGroups(), aggregatePeriod(), answerPosJournalAiQuestion(), boundedInteger(), boundedText(), buildDeterministicPosJournalAnalysis(), buildDeterministicPosJournalAnswer() (+31 more)
...
Cohesion: 0.10
Nodes (37): FOOTER_COUNT_RETRY_STORE_KEYS, FORCE_RECEIPT_RETRY_STORE_KEYS, PRINTED_TIME_RETRY_STORE_KEYS, processReceiptImageEvent(), ChatStoreBot, DbClient, mtalkMediaMessageId(), processStoreRoomImageLikeLine() (+29 more)
...
Cohesion: 0.13
Nodes (37): applyCorrectionFieldValue(), buildCorrectionFlexHeader(), buildFieldSelectionPrompt(), buildReceiptCorrectionCancelOnlyFooter(), buildReceiptCorrectionConfirmCancelFooter(), buildUpdatedReceiptFlexReply(), buildValueInputPrompt(), clearPendingCorrection() (+29 more)
...
Cohesion: 0.09
Nodes (24): assertIconFile(), closeAccountMenu(), closeTalkContextMenu(), copyInvite(), currentRoomAllowsJournalAi(), currentRoomHasOnlyMeAndBots(), findMineGroup(), inviteLink() (+16 more)
...
Cohesion: 0.13
Nodes (34): indexLineRoomReceiptSearch(), normalizeReceiptCorrectionInputValue(), buildReceiptSummaryText(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour() (+26 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (59): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), buildStoreKnowledgeSearchText(), chunkArray(), createStoreKnowledgeDownloadUrl(), deleteChatPdfHistoryItem(), deleteDocumentById(), deleteMediaItemById() (+51 more)
...
Cohesion: 0.14
Nodes (29): CORS_HEADERS, DbClient, ensureManagerNoticeRoom(), filePayload(), handleDispatch(), handleSignupNotify(), handleSignupReviewed(), handleStoreChangeNotify() (+21 more)

### Community 45 - "Community 45"
Cohesion: 0.12
Nodes (30): DailyTotals, EMPTY_RESULT, extractDailyTotalsFromReport(), isJournalSalesSyncEnabled(), isRecord(), JournalSalesSyncResult, normalizeDate(), rebuildMonthsFromDays() (+22 more)
...
Cohesion: 0.18
Nodes (28): dedupeSalesSearchRows(), executeSalesSearch(), buildReceiptChatCard(), buildReceiptFlexMessage(), field(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa() (+20 more)
...
Cohesion: 0.15
Nodes (25): issueAdminDashboardLoginLinkToken(), BUDGET_NOTICE_LINES, budgetConfirmFlex(), budgetDoneFlex(), budgetFlex(), CANCEL_WORDS, clearPending(), commitBudgetAndReply() (+17 more)
...
Cohesion: 0.19
Nodes (20): handleStoreReceiptTextMessage(), startCorrectionSession(), countFromRawOrDb(), currencyFromRawOrDb(), deleteReceiptSearchIndexEntries(), deleteReceiptSearchIndexForDate(), deleteReceiptsForDateByLineMessageIds(), deleteReceiptsForDateExcludingLineMessageId() (+12 more)
...
Cohesion: 0.22
Nodes (17): mtalkSyntheticRoomId(), loadMtalkRoomFlags(), assertIsolatedRoomId(), DbClient, deleteExact(), dropRoomMessageTable(), isMissingRelation(), purgeLineAdminRoom() (+9 more)
...
Cohesion: 0.13
Nodes (11): chat, migration, root, chat, migration, singleReactionMigration, chat, chatHtml (+3 more)
...
Cohesion: 0.29
Nodes (7): applyRoomViewCache(), isMultiMemberGroup(), paintChatHeader(), roomHasStoreBot(), roomIcon(), toggleMemberStrip(), updateChatHeaderMeta()
...
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 10` to `Community 0`, `Community 64`, `Community 21`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `xlsx` connect `Community 21` to `Community 162`, `Community 10`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 162` to `Community 2`, `Community 21`?**
