...
## Summary
- 4158 nodes · 9725 edges · 343 communities (206 shown, 137 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 197 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c22321eb`
...
Cohesion: 0.03
Nodes (60): As(), average(), beforeDatasetDraw(), beforeDatasetsDraw(), buildTicks(), d(), dataset(), destroy() (+52 more)
...
Cohesion: 0.07
Nodes (21): Ae(), afterDraw(), afterEvent(), afterUpdate(), ba, Bi(), Ee(), f() (+13 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (51): a(), aa(), ai(), ao(), at(), b(), beforeDraw(), cn() (+43 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (22): beforeUpdate(), bn(), Ci(), ei(), go(), ii(), initialize(), je() (+14 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (45): buildSavedReportHtmlStoragePath(), chunkArray(), createSavedReportHtmlSignedUrl(), createSignedMediaUrl(), createStoreKnowledgeDownloadUrl(), deleteChatPdfHistoryItem(), deleteDocumentById(), deleteMediaItemById() (+37 more)
...
Cohesion: 0.07
Nodes (53): addReceiptToCohort(), buildLineUserPermissionPayload(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), deleteStoreKnowledgeItem(), emptyCohortBucket(), extractPdfText(), fetchManualMonthGross() (+45 more)
...
Cohesion: 0.06
Nodes (19): bo, ca(), _calculateBarIndexPixels(), _calculateBarValuePixels(), determineDataLimits(), getBasePixel(), getLabelAndValue(), getLabelForValue() (+11 more)
...
Cohesion: 0.08
Nodes (34): buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken(), sendLinePush(), SPORT_ICON (+26 more)
...
Cohesion: 0.06
Nodes (13): Be(), Do(), eo(), getMaxOverflow(), jn, n(), ne(), numeric() (+5 more)
...
Cohesion: 0.40
Nodes (6): buildPastSalesSheetUpdatesFromDb(), fetchPastSalesSnapshotMap(), fetchReceiptMonthlyAggregatesForStore(), parseOptionalPastSalesInt(), sheetPastRowIsManualEntry(), sheetPastRowUpdatedAt()
...
- **Why does `xlsx` connect `Community 86` to `Community 40`, `Community 81`, `Community 114`?**
  _High betweenness centrality (0.268) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 81` to `Community 1`, `Community 20`, `Community 86`?**
  _High betweenness centrality (0.266) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 114` to `Community 3`, `Community 86`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.027197346600331674 - nodes in this community are weakly interconnected._
