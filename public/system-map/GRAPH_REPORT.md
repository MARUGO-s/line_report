...
## Summary
- 5059 nodes · 11028 edges · 501 communities (316 shown, 185 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f470f3d`
...
6. `answerFoodCourtQuestion()` - 31 edges
7. `processPullRowsToDb()` - 31 edges
8. `handleDispatch()` - 31 edges
...
## Communities (501 total, 185 thin omitted)
...
Cohesion: 0.05
Nodes (80): importDailyReceiptsCommit(), parseManualDaySalesImport(), CORS_HEADERS, DbClient, ensureManagerNoticeRoom(), filePayload(), handleDispatch(), handleSignupNotify() (+72 more)
...
Cohesion: 0.06
Nodes (66): addReceiptToCohort(), buildSavedReportHtmlStoragePath(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), createSavedReportHtmlSignedUrl(), emptyCohortBucket(), fetchChatPdfHistoryItem(), fetchChatPdfHistoryList() (+58 more)
...
Cohesion: 0.05
Nodes (69): azureFoundryUsageFrom(), buildDailyLogsContext(), buildFoodCourtAckFlex(), buildFoodCourtCompareFlex(), buildFoodCourtDashboardLink(), buildFoodCourtDateConfirmFlex(), buildFoodCourtPageUrl(), checkFoodCourtReceiptConsistency() (+61 more)
...
Cohesion: 0.09
Nodes (44): upsertPosJournalAutoReports(), allocateDayPaymentsToSales(), allocateDayTaxToSales(), buildJournalSavedReportHtml(), buildJournalSavedReportsFromPosDays(), buildPosJournalDaysFromSavedReports(), classifyPosJournalReportItem(), dateRangeLabel() (+36 more)

### Community 18 - "Community 18"
Cohesion: 0.10
Nodes (40): analyzePosJournalWithAi(), askPosJournalAi(), recordPosJournalAiUsage(), buildStoreLocationPromptBlock(), aggregateGroups(), aggregatePeriod(), answerPosJournalAiQuestion(), boundedInteger() (+32 more)
...
Cohesion: 0.05
Nodes (43): better-sqlite3, dotenv, express, dependencies, better-sqlite3, dotenv, express, xlsx (+35 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (39): addDaysIsoUtc(), fetchAnalyticsMonthly(), fetchDistinctRoomIdsFromRawTable(), fetchManualMonthsForYearState(), fetchReceiptDailyAggForRange(), fetchReceiptSalesState(), fetchReceiptWebhookStatus(), fetchSalesBudgetRow() (+31 more)
...
Cohesion: 0.09
Nodes (34): createPettyCashEntryFromReceiptImage(), FOOTER_COUNT_RETRY_STORE_KEYS, FORCE_RECEIPT_RETRY_STORE_KEYS, PRINTED_TIME_RETRY_STORE_KEYS, processReceiptImageEvent(), resolveClaudeApiKey(), ChatStoreBot, DbClient (+26 more)
...
Cohesion: 0.09
Nodes (36): buildDailySalesConfirmFlex(), buildDailySalesImportedFlex(), buildDailySalesSummaryRows(), buildDailySalesTemplateDownloadFlex(), buildReservationConfirmFlex(), buildReservationImportDetailJson(), buildReservationRegisteredFlex(), buildReservationUpdatedFlex() (+28 more)
...
Cohesion: 0.11
Nodes (33): appendReservationHonorific(), buildGmailReservationFlexAltText(), buildReservationCalendarDetailPayload(), buildReservationDetailLabel(), buildReservationTemplateData(), extractStoreNameFromBody(), fallbackField(), formatReservationDateTimeLabel() (+25 more)
...
Cohesion: 0.12
Nodes (31): bearerToken(), constantTimeEqual(), CORS_HEADERS, isAuthorized(), isServiceRoleAuthorized(), clearBistrocavacavaSheetDataRowsAndPushFromDb(), canonicalKeepStoreKey(), clearSpreadsheetTabsExceptStores() (+23 more)
...
Cohesion: 0.14
Nodes (30): formatSheetA1Range(), appendSheetValuesForTab(), appendSyncLog(), buildDailySalesExportRows(), exportBudgetFromDbToBudgetSheet(), exportClosedDatesFromDbToBudgetSheet(), exportPastSalesFromDbToPastSheet(), getSheetValuesForTab() (+22 more)
...
Cohesion: 0.11
Nodes (22): buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken(), SPORT_ICON, WDAY_JP (+14 more)

### Community 48 - "Community 48"
Cohesion: 0.15
Nodes (28): indexLineRoomReceiptSearch(), startCorrectionSession(), buildReceiptSummaryText(), buildReceiptTextReply(), formatYenAmount(), isPlausibleReceiptCount(), looksLikeOcrLatinStoreLabel(), resolveCanonicalStoreDisplayName() (+20 more)
...
Cohesion: 0.15
Nodes (26): issueAdminDashboardLoginLinkToken(), BUDGET_NOTICE_LINES, budgetConfirmFlex(), budgetDoneFlex(), budgetFlex(), CANCEL_WORDS, clearPending(), commitBudgetAndReply() (+18 more)
...
Cohesion: 0.22
Nodes (23): dedupeSalesSearchRows(), executeSalesSearch(), buildReceiptChatCard(), buildReceiptFlexMessage(), field(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa() (+15 more)

### Community 63 - "Community 63"
Cohesion: 0.14
Nodes (23): getStoreLocationProfile(), LABEL_SET, MARUGO_GROUP_STORE_OPTIONS, STORE_COORDINATES, STORE_LOCATION_PROFILES, StoreLocationProfile, buildAiCreditLine(), buildWeatherForecastReply() (+15 more)
...
Cohesion: 0.13
Nodes (23): buildGroupSalesDatePromptFlex(), buildGroupSalesSearchGuideFlex(), buildGroupSalesSearchGuideText(), buildKindPromptFlex(), buildSearchMenuFlex(), flexParagraph(), isLineDirectMessageEvent(), isLineSearchControlText() (+15 more)

### Community 66 - "Community 66"
Cohesion: 0.19
Nodes (22): normalizeReceiptCorrectionInputValue(), clamp01(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour(), formatJapaneseReceiptDateFromIso(), getJstBusinessDateForReceiptBudget(), isSingleDayPeriodSettlementReport() (+14 more)
...
Cohesion: 0.12
Nodes (21): buildPosJournalRepairPayload(), buildPosJournalStoragePath(), deletePosJournalFile(), ensureJournalProductIndexMonths(), ensurePosJournalStorageForRepair(), extractFileExt(), fetchPosJournalAiHistory(), fetchPosJournalCategoryOverrides() (+13 more)
...
Cohesion: 0.22
Nodes (19): clearSearchPending(), detectKindTrigger(), isCancelText(), isLineSearchIntentText(), isMenuTrigger(), loadSearchPending(), MENU_TRIGGERS, normalizeTriggerText() (+11 more)
...
Cohesion: 0.19
Nodes (19): archiveChatMedia(), authenticateChatMember(), buildRoomConfigSafePayload(), callKnowledgeGemini(), handleChatRoomConfig(), handleChatRoomPurge(), handleChatScheduleEvent(), issueChatJournalLoginLink() (+11 more)
...
Cohesion: 0.16
Nodes (13): buildCasualSystemPrompt(), buildWebSearchReference(), EXTERNAL_TOPIC_RE, fetchMtalkWebSearch(), MODEL_SET, MTALK_WEB_SEARCH_MODELS, MtalkWebSearchModel, MtalkWebSearchResult (+5 more)
...
Cohesion: 0.13
Nodes (13): read(), read(), root, read(), root, read(), readChatPageSource(), read() (+5 more)
...
Cohesion: 0.26
Nodes (16): exchangeChatMediaViewLink(), authenticateAdminDashboardSessionToken(), base64UrlEncode(), constantTimeEqualHex(), exchangeAdminDashboardLoginLinkToken(), exchangeRoomConfigLoginLink(), generateOpaqueToken(), hashRoomConfigPassword() (+8 more)
...
Cohesion: 0.14
Nodes (13): ChatCard, ChatCardFieldRow, ChatCardListItem, ChatCardPayload, DbClient, dispatchChatPush(), postChatCardIndependent(), resolveChatGroupId() (+5 more)
...
Cohesion: 0.18
Nodes (10): chat, migration, root, chat, expectedStoreLogos, chatScriptPaths(), publicDir, readChatPageSourceSync() (+2 more)
...
Cohesion: 0.23
Nodes (14): buildSearchEntryReply(), handleLineSearchPostback(), handleLineSearchTextMessage(), isLineDirectMessageChat(), isLineInvitedChatRoom(), isLineSearchPostbackAction(), loadDirectMessageSearchFlags(), loadRoomSearchFlags() (+6 more)
...
Cohesion: 0.32
Nodes (11): ChatCardAction, ChatCardSection, emitFlexNote(), flexColor(), FlexField, flexNoteSize(), FlexWalkOut, flexWeight() (+3 more)
...
Cohesion: 0.29
Nodes (12): buildSearchMenuFooter(), executeCalendarSearch(), executeMediaSearch(), executeMessageSearch(), flexFullTextBlocks(), formatRoomLabel(), isDirectMessageRoomId(), isLineInvitedChatRoomId() (+4 more)
...
Cohesion: 0.39
Nodes (8): createPettyCashEntry(), normalizePettyItems(), normalizePettyTaxMode(), PETTY_ACCT_KEYS, pettyCategoryLabel(), pettyItemText(), pettyTotalsFromItems(), updatePettyCashEntry()

### Community 151 - "Community 151"
Cohesion: 0.39
Nodes (8): sendLinePushMessages(), sendLinePush(), sendLinePush(), sendLinePushMessages(), isBlockedByMarugosecondLockdown(), MARUGOSECOND_LOCKDOWN_ALLOWED_ROOM_IDS, isMtalkSyntheticRoomId(), sendLinePush()
...
## Knowledge Gaps
- **906 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+901 more)
...
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 2` to `Community 0`, `Community 21`, `Community 29`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `xlsx` connect `Community 21` to `Community 74`, `Community 2`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 74` to `Community 3`, `Community 21`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _906 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.01799507681860623 - nodes in this community are weakly interconnected._
