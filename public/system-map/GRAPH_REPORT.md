...
## Summary
- 5722 nodes · 12605 edges · 546 communities (350 shown, 196 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f0880f75`
...
7. `answerFoodCourtQuestion()` - 33 edges
...
- `renderMemberStrip()` --indirect_call--> `item()`  [INFERRED]
  public/chat/rooms.js → tests/foodcourt_journal_link.test.ts
...
## Communities (546 total, 196 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (138): addDaysIso(), AdminAuthenticationResult, AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, assertChatAdminAuditScope(), assertChatAdminBotScope() (+130 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (85): buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup(), buildReservationSummaryLookup(), buildSavedReportHtmlStoragePath(), chooseLaterIso(), createSavedReportHtmlSignedUrl(), deleteChatPdfHistoryItem(), deleteDocumentById() (+77 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (102): addPriceHistory(), addPriceTx, adjustProductStockQty(), adjustProductStockQtyTx, attachAliases(), buildProductWritePayload(), completeIngestionFile(), countIngestionErrorsByFileStmt (+94 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (92): findCurrentPricesByQuery(), getActiveReplyTemplateByKey(), getAdminTokenOverride(), listReplyTemplates(), renderTemplate(), saveOcrResult(), upsertReplyTemplate(), app (+84 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (85): applySheetMissingMonthDeletions(), BudgetComparable, budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates() (+77 more)
...
Cohesion: 0.05
Nodes (64): foodCourtRoleProvider(), buildDailyLogsContext(), buildFoodCourtAckFlex(), buildFoodCourtCompareFlex(), buildFoodCourtDashboardLink(), buildFoodCourtDateConfirmFlex(), buildFoodCourtPageUrl(), checkFoodCourtReceiptConsistency() (+56 more)
...
Cohesion: 0.06
Nodes (54): assertReservationEventMatchesStoreScope(), buildCalendarVisitMonthLabel(), buildCalendarVisitTimeLabel(), buildChatScheduleReservationDetail(), buildJstMonthRange(), buildReservationCalendarItem(), buildReservationNameSearchPatterns(), clampInt() (+46 more)
...
Cohesion: 0.07
Nodes (46): allocateUnits(), ASSUMPTION_RULES, BASIS_RANK, buildDataGaps(), buildKpiScenarioPack(), computeScenario(), deriveKpiBaselineFromUnifiedSales(), emptyKpiBaseline() (+38 more)
...
Cohesion: 0.09
Nodes (44): archiveChatMedia(), authenticate(), authenticateChatMember(), buildFoodCourtWeeklyReportLink(), decideChatMenuKnowledge(), exchangeChatJournalLoginLink(), exchangeChatMediaViewLink(), handleChatRoomConfig() (+36 more)
...
Cohesion: 0.08
Nodes (33): allocateFoodCourtHourlyTargets(), buildFoodCourtJournalDetail(), FoodCourtJournalDetail, Product, Range, ratio(), buildFoodCourtKpiInputs(), FoodCourtKpiContext (+25 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (40): getJapaneseHolidayDateSet(), fetchManualMonthSales(), buildFoodcourtReportUri(), buildComparableEndDateForMonth(), computeBudgetDiffs(), computeComparableMonthProgressRatio(), DayAgg, dayOfMonthFromIso() (+32 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (39): resolveFoodCourtPassingAwareCacheVersion(), buildLoopFeedback(), evaluateFoodCourtAnswer(), foodCourtEvalDeadlineAt(), parseLoopEvaluationJson(), resolveFoodCourtOpenAiModel(), runFoodCourtLoopEngineering(), saveFoodCourtLoopIteration() (+31 more)

### Community 32 - "Community 32"
Cohesion: 0.13
Nodes (39): indexLineRoomReceiptSearch(), upsertManualDaySalesEntries(), normalizeReceiptCorrectionInputValue(), buildReceiptSummaryText(), buildReceiptTextReply(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences() (+31 more)

### Community 33 - "Community 33"
Cohesion: 0.10
Nodes (41): asGroqVisionContentType(), buildAwardsFromHints(), buildDrinkingWindowFromHints(), buildRatingPointsFromHints(), buildSourceUrlLines(), buildWebSummaryContext(), buildWineryHistoryFromHints(), collectAwardHintsFromText() (+33 more)
...
Cohesion: 0.11
Nodes (35): createPettyCashEntryFromReceiptImage(), recordPettyCashWebAiUsage(), processReceiptImageEvent(), ChatStoreBot, DbClient, menuKnowledgeFromLineImageAnalysis(), mtalkMediaMessageId(), preferMenuKnowledgeResult() (+27 more)

### Community 39 - "Community 39"
Cohesion: 0.12
Nodes (33): importDailyReceiptsCommit(), parseManualDaySalesImport(), buildSimpleNoticeFlex(), handleDailySalesImportPostback(), processDailySalesFileEvent(), clearDailyReceiptsForMonth(), countExistingReceiptsForDates(), DailySalesImportEntry (+25 more)
...
Cohesion: 0.10
Nodes (31): attachJournalStoreContext(), date(), loadJournalStoreContext(), number(), oneOf(), ProfileDatabase, ProfileResult, rebaseJournalWineAnalysis() (+23 more)
...
Cohesion: 0.13
Nodes (26): appendReceiptSheetsBackgroundSyncSummaryLog(), buildDailySalesExportRows(), listPilotSyncMonthsJst(), pushDailySalesToSheet(), runReceiptSheetsPilotSync(), runReceiptSheetsPilotSyncChainedStep(), runReceiptSheetsPilotSyncForStore(), runWithConcurrencyLimit() (+18 more)
...
Cohesion: 0.09
Nodes (23): ChatAction, CORS_HEADERS, helpCard(), SearchKind, ChatCard, ChatCardAction, ChatCardFieldRow, ChatCardListItem (+15 more)
...
Cohesion: 0.13
Nodes (25): BUDGET_NOTICE_LINES, budgetConfirmFlex(), budgetDoneFlex(), budgetFlex(), CANCEL_WORDS, clearPending(), commitBudgetAndReply(), conversationKey() (+17 more)
...
Cohesion: 0.13
Nodes (24): fetchAnalyticsMonthly(), fetchReceiptDailyAggForRange(), fetchManualMonthSalesMapForStore(), sanitizeReceiptCountFromDb(), buildDailySeriesForStoreMonth(), fetchReceiptMonthlyAggregatesForStore(), amount(), emptyUnifiedSalesDay() (+16 more)
...
Cohesion: 0.17
Nodes (25): normalizeReceiptFieldText(), RECEIPT_SHEETS_STORE_CATALOG, alignReceiptStoreNameToRegistry(), findRegistryEntryForParsedStoreName(), normalizeStoreCompareKey(), receiptStoreNameMatchesRegistry(), resolveParsedStoreNameForDisplay(), StoreRegistryMatchCandidate (+17 more)
...
Cohesion: 0.11
Nodes (27): asNullableWineField(), buildGrapeCompositionFromEvidence(), buildJpyPriceRangeInfo(), buildLineWineReplyFallback(), buildWineAnalysisFallback(), computeWineConfidence(), countTokenMatches(), emptyWineAnalysisResult() (+19 more)
...
Cohesion: 0.23
Nodes (23): executeSalesSearch(), buildReceiptChatCard(), buildReceiptFlexMessage(), field(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa(), formatYenOrDash() (+15 more)
...
Cohesion: 0.15
Nodes (21): purgeChatAdminRoom(), mtalkSyntheticRoomId(), DbClient, loadMtalkRoomFlags(), MtalkRoomFlags, MtalkStoreBot, assertIsolatedRoomId(), DbClient (+13 more)

### Community 78 - "Community 78"
Cohesion: 0.12
Nodes (14): actualEventAttendance(), capacityBaseAttendance(), FOODCOURT_VENUE_CAPACITY, FoodCourtAttendanceEvent, maxActualEventAttendance(), ResolvedFoodCourtAttendance, resolveEventAttendance(), resolveGroqTextModel() (+6 more)
...
Cohesion: 0.20
Nodes (14): saveSavedReport(), DailyTotals, EMPTY_RESULT, extractDailyTotalsFromReport(), isJournalSalesSyncEnabled(), isRecord(), JournalSalesSyncResult, normalizeDate() (+6 more)
...
Cohesion: 0.15
Nodes (19): asSourceDisplayName(), buildSourceSummary(), buildWineSources(), detectSearchMode(), enrichWebCandidatesForMissingFields(), extractHostname(), fetchJsonWithTimeout(), flattenDuckDuckGoTopics() (+11 more)
...
Cohesion: 0.20
Nodes (18): buildPosJournalRepairPayload(), buildPosJournalStoragePath(), deletePosJournalFile(), ensureJournalProductIndexMonths(), ensurePosJournalStorageForRepair(), extractFileExt(), isPosJournalDetailMismatchRow(), isPosJournalPlaceholderRow() (+10 more)
...
Cohesion: 0.16
Nodes (16): addIngestionError(), createIngestionFile(), createStore(), nowIso(), recordIngestionProductSnapshot(), resolveStoreId(), saveLineEvent(), asDate() (+8 more)
...
Cohesion: 0.12
Nodes (11): chat, migration, singleReactionMigration, chat, chatSource, chatHtml, helpManual, migration (+3 more)
...
Cohesion: 0.21
Nodes (13): fillPosJournalDaysWeather(), posJournalMonthBounds(), resolvePosJournalAiSummary(), applyCachedWeatherToPosJournalDays(), applyPosJournalCategoryOverrides(), buildPosJournalSummary(), isPosJournalAdjustmentItem(), mergePosJournalDaysPreferPrimary() (+5 more)
...
Cohesion: 0.23
Nodes (12): buildMarketPriceFromHints(), formatPriceAmount(), parsePriceHintValue(), boundedStrings(), buildMtalkMenuKnowledgeCard(), MtalkMenuKnowledgeItem, MtalkMenuKnowledgeStatus, normalizeMtalkMenuKnowledgeAnalysis() (+4 more)
...
Cohesion: 0.24
Nodes (12): createSignedMediaUrl(), fetchChatMediaView(), fetchLineMediaUsageStats(), fetchMediaCountByStore(), fetchMediaState(), fetchPettyCashReceiptMedia(), fetchRoomNameMapForIds(), fetchSenderNameMapForUserIds() (+4 more)
...
Cohesion: 0.19
Nodes (18): manualMonthSalesFromRow(), ManualMonthSalesRecord, ManualMonthSalesUpsertEntry, normalizeSheetIntegerInput(), normalizeUpdatedAtInput(), parseManualMonthOperatingDays(), parseManualMonthPartyGuestFromUnknown(), parseOptionalNonNegativeInt() (+10 more)
...
Cohesion: 0.40
Nodes (9): buildReceiptReportAggregateFromRows(), loadReceiptReportAggregateForRoom(), normalizeConfiguredStorePartitionKey(), receiptDateIsoFromValue(), ReceiptReportAggregate, resolveStorePartitionKeyForRoom(), toReceiptStorePartitionKey(), findBestStoreNameInText() (+1 more)
...
Cohesion: 0.11
Nodes (33): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), buildStoreKnowledgeSearchText(), callKnowledgeGemini(), createStoreKnowledgeDownloadUrl(), deleteStoreKnowledgeItem(), fetchStoreKnowledgeItem(), fetchStoreKnowledgeItems() (+25 more)
...
- **Why does `item()` connect `Community 112` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 134`, `Community 13`, `Community 14`, `Community 15`, `Community 19`, `Community 22`, `Community 27`, `Community 29`, `Community 161`, `Community 33`, `Community 37`, `Community 169`, `Community 41`, `Community 50`, `Community 58`, `Community 65`, `Community 74`, `Community 89`, `Community 94`, `Community 101`, `Community 107`, `Community 109`, `Community 127`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `renderMemberStrip()` connect `Community 161` to `Community 112`, `Community 116`, `Community 45`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `roomHasStoreBot()` connect `Community 149` to `Community 116`, `Community 45`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Are the 48 inferred relationships involving `item()` (e.g. with `renderMemberStrip()` and `collect()`) actually correct?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.01754015215553677 - nodes in this community are weakly interconnected._
