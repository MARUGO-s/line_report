...
## Summary
- 4104 nodes · 9602 edges · 336 communities (202 shown, 134 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 197 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `554333df`
...
## Communities (336 total, 134 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (50): afterUpdate(), As(), beforeDatasetDraw(), beforeDatasetsDraw(), beforeLayout(), Bt(), buildTicks(), d() (+42 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (82): addDaysIso(), AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, authenticate(), authenticateRawAdminToken(), backfillLineUserPermissionsFromMessages() (+74 more)
...
Cohesion: 0.06
Nodes (70): a(), aa(), ai(), ao(), at(), b(), beforeDraw(), cn() (+62 more)
...
Cohesion: 0.06
Nodes (17): addBox(), addElements(), afterDatasetsUpdate(), an(), dt(), generateLabels(), ke(), kn() (+9 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (19): Ae(), afterDraw(), afterEvent(), ba, Bi(), configure(), Ee(), f() (+11 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (14): beforeUpdate(), bn(), go(), ii(), initialize(), labelColor(), labelPointStyle(), ns() (+6 more)
...
Cohesion: 0.08
Nodes (58): replyLineFlex(), resolveChannelAccessToken(), buildFlexInfoCard(), buildLineFlexBlueHeader(), flexButton(), FlexButtonAction, FlexButtonSpec, lineSafeFlexText() (+50 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (19): ca(), _calculateBarIndexPixels(), _calculateBarValuePixels(), Ci(), Do(), eo(), getBasePixel(), getLabelAndValue() (+11 more)
...
Cohesion: 0.08
Nodes (48): buildHardcodedHolidayMap(), fetchCaoHolidayMap(), fetchJapaneseHolidayMap(), fetchJapaneseHolidaySet(), getJapaneseHolidayDateSet(), HolidayLiveCache, JAPANESE_HOLIDAY_ISO_DATES, JapaneseHolidaySource (+40 more)
...
Cohesion: 0.06
Nodes (14): buildLookupTable(), En, Fo(), _generate(), getDecimalForValue(), _getTimestampsForTable(), In(), init() (+6 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (51): buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup(), buildReservationSummaryLookup(), buildSavedReportHtmlStoragePath(), chooseLaterIso(), chunkArray(), createSavedReportHtmlSignedUrl(), createSignedMediaUrl() (+43 more)
...
Cohesion: 0.08
Nodes (48): addReceiptToCohort(), asAppError(), buildLineUserPermissionPayload(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), deleteStoreKnowledgeItem(), emptyCohortBucket(), fetchManualMonthGross() (+40 more)
...
Cohesion: 0.07
Nodes (9): Be(), bo, getValueForPixel(), ko, n(), ne(), numeric(), pi() (+1 more)
...
Cohesion: 0.17
Nodes (26): indexLineRoomReceiptSearch(), buildReceiptSummaryText(), isPlausibleReceiptCount(), parseCurrencyAmount(), parseIntegerCount(), resolveReceiptReplyDayValues(), countFromRawOrDb(), currencyFromRawOrDb() (+18 more)

### Community 47 - "Community 47"
Cohesion: 0.14
Nodes (26): executeSalesSearch(), buildReceiptFlexMessage(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa(), formatYenOrDash(), kvRow(), sectionTitle() (+18 more)
...
Cohesion: 0.14
Nodes (24): applySauvageNetSalesAsGrossSales(), buildReceiptTextReply(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour(), formatJapaneseReceiptDateFromIso() (+16 more)
...
Cohesion: 0.10
Nodes (29): analyzePosJournalWithAi(), askPosJournalAi(), buildDocumentStoragePath(), buildPosJournalStoragePath(), createPettyCashEntry(), createPettyCashEntryFromReceiptImage(), extractFileExt(), fetchPosJournalRows() (+21 more)

### Community 62 - "Community 62"
Cohesion: 0.19
Nodes (18): ensureLineRoomDisplayNameFromWebhook(), ensureLineUserDisplayNameFromWebhook(), fetchLineConversationNameByRoomId(), fetchLineConversationNameByUrl(), fetchLineDisplayNameByUrl(), fetchLineDisplayNameByUserId(), isAutoDisplayNamesEnabled(), runWebhookDisplayNameSync() (+10 more)
...
Cohesion: 0.26
Nodes (14): buildReceiptStoreMismatchFlexReply(), buildStoreMismatchGuidance(), buildStoreMismatchGuidanceText(), capText(), clearPendingStoreNameMismatch(), conversationKey(), formatJapaneseReceiptDateFromIso(), kvRow() (+6 more)
...
Cohesion: 0.22
Nodes (6): average(), ei(), Hs, je(), qe(), ti()
...
## Knowledge Gaps
- **645 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+640 more)
...
- **Why does `xlsx` connect `Community 87` to `Community 40`, `Community 114`, `Community 83`?**
  _High betweenness centrality (0.285) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 83` to `Community 1`, `Community 18`, `Community 87`?**
  _High betweenness centrality (0.280) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 114` to `Community 3`, `Community 87`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.027588964414234307 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.022604422604422605 - nodes in this community are weakly interconnected._