...
## Summary
- 5475 nodes · 11973 edges · 525 communities (335 shown, 190 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 99 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4febc885`
...
2. `isRecord()` - 82 edges
3. `normalizeInlineText()` - 51 edges
...
9. `generateFoodCourtDailySummary()` - 31 edges
10. `generateFoodCourtPeriodSummary()` - 31 edges
...
- `renderSheetPreview()` --indirect_call--> `row()`  [INFERRED]
  public/chat/attachments.js → tests/foodcourt_forecast_engine.test.ts
- `loadQuotedMessages()` --indirect_call--> `row()`  [INFERRED]
  public/chat/messages.js → tests/foodcourt_forecast_engine.test.ts
- `renderForwardUsers()` --indirect_call--> `row()`  [INFERRED]
  public/chat/messages.js → tests/foodcourt_forecast_engine.test.ts
- `renderRegisteredUsers()` --indirect_call--> `row()`  [INFERRED]
  public/chat/rooms.js → tests/foodcourt_forecast_engine.test.ts
...
## Communities (525 total, 190 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (137): addDaysIso(), AdminAuthenticationResult, AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, applyChatAdminTemplate(), assertChatAdminAuditScope() (+129 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (97): addPriceHistory(), addPriceTx, adjustProductStockQty(), adjustProductStockQtyTx, buildProductWritePayload(), completeIngestionFile(), countIngestionErrorsByFileStmt, countIngestionProductSnapshotsByFileStmt (+89 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (71): backupDatabaseTo(), getAdminTokenOverride(), app, asBackupTimestamp(), buildCatalogDetailLines(), buildCustomHeaderMap(), buildMarketPriceFromHints(), buildSearchQueryVariants() (+63 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (87): BudgetComparable, budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates(), buildBudgetSheetRowUpdatesFromDb() (+79 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (104): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), buildSavedReportHtmlStoragePath(), buildStoreKnowledgeSearchText(), callKnowledgeGemini(), chunkArray(), createSavedReportHtmlSignedUrl(), createSignedMediaUrl() (+96 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (65): processReceiptImageEvent(), ChatStoreBot, DbClient, mtalkMediaMessageId(), preferMenuKnowledgeResult(), processStoreRoomImageLikeLine(), resolveClaudeApiKey(), saveStoreRoomFileToMediaLibrary() (+57 more)
...
Cohesion: 0.05
Nodes (67): foodCourtRoleProvider(), buildDailyLogsContext(), buildFoodCourtAckFlex(), buildFoodCourtCompareFlex(), buildFoodCourtDashboardLink(), buildFoodCourtDateConfirmFlex(), buildFoodCourtPageUrl(), checkFoodCourtReceiptConsistency() (+59 more)
...
Cohesion: 0.10
Nodes (33): addReceiptToCohort(), buildJournalProductIndexMonthSnapshot(), filterFromProductSearchObject(), isPosJournalDetailMismatchRow(), isWeekendBusinessDate(), itemMatchesPosProductFilter(), normalizeCohortComparisonSpec(), normalizePosProductSearchText() (+25 more)
...
Cohesion: 0.09
Nodes (53): bearerToken(), constantTimeEqual(), CORS_HEADERS, isAuthorized(), isServiceRoleAuthorized(), clearBistrocavacavaSheetDataRowsAndPushFromDb(), canonicalKeepStoreKey(), clearSpreadsheetTabsExceptStores() (+45 more)
...
Cohesion: 0.07
Nodes (51): assertReservationEventMatchesStoreScope(), buildCalendarVisitMonthLabel(), buildCalendarVisitTimeLabel(), buildChatScheduleReservationDetail(), buildJstMonthRange(), buildReservationCalendarItem(), buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup() (+43 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (47): better-sqlite3, dotenv, @electric-sql/pglite, express, dependencies, better-sqlite3, dotenv, express (+39 more)
...
Cohesion: 0.10
Nodes (48): dedupeSalesSearchRows(), executeSalesSearch(), buildReceiptChatCard(), buildReceiptFlexMessage(), field(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa() (+40 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (46): replyLineFlex(), buildFlexInfoCard(), ADMIN_MENU_POSTBACK, adminHelpButton(), applyRoomApproval(), applyUserApproval(), ApprovalCommand, buildAdminHelpFlex() (+38 more)
...
Cohesion: 0.09
Nodes (44): asGroqVisionContentType(), buildAwardsFromHints(), buildDrinkingWindowFromHints(), buildRatingPointsFromHints(), buildSourceUrlLines(), buildWebSummaryContext(), buildWineryHistoryFromHints(), collectAwardHintsFromText() (+36 more)
...
Cohesion: 0.08
Nodes (37): addDaysIsoUtc(), fetchAnalyticsMonthly(), fetchDistinctRoomIdsFromRawTable(), fetchManualMonthsForYearState(), fetchReceiptDailyAggForRange(), fetchReceiptSalesState(), fetchReceiptWebhookStatus(), fetchSalesBudgetRow() (+29 more)
...
Cohesion: 0.08
Nodes (39): resolveFoodCourtPassingAwareCacheVersion(), buildLoopFeedback(), evaluateFoodCourtAnswer(), foodCourtEvalDeadlineAt(), loadFoodCourtLearningMemory(), parseLoopEvaluationJson(), resolveFoodCourtOpenAiModel(), runFoodCourtLoopEngineering() (+31 more)
...
Cohesion: 0.08
Nodes (44): buildPosJournalRepairPayload(), buildPosJournalStoragePath(), combineJournalProductDetailCoverage(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), deletePosJournalFile(), emptyCohortBucket(), ensureJournalProductIndexMonths() (+36 more)
...
Cohesion: 0.12
Nodes (31): buildReminderFlex(), DbClient, loadEventsForDate(), resolveStoreLineToken(), sanitizeLineToken(), sendLinePushMessages(), TargetRoomTask, truncate() (+23 more)
...
Cohesion: 0.15
Nodes (34): importDailyReceiptsCommit(), parseManualDaySalesImport(), buildSimpleNoticeFlex(), handleDailySalesImportPostback(), processDailySalesFileEvent(), postChatCard(), postStoreRoomLineStyleReply(), clearDailyReceiptsForMonth() (+26 more)
...
Cohesion: 0.07
Nodes (26): AI_RATE_LIMITS, AiAction, boundedIsoDate(), boundedNonNegativeInteger(), boundJournalFoodcourtIntegrationReports(), BRIEF_CACHE_TTL_MS, buildJournalAiServerPolicy(), buildReservationImportCoveragePolicy() (+18 more)
...
Cohesion: 0.08
Nodes (29): buildLineUserPermissionPayload(), clampInt(), fetchChatMediaView(), fetchGlobalSettings(), fetchLineMediaUsageStats(), fetchLineUserPermissions(), fetchMediaCountByStore(), fetchMediaState() (+21 more)
...
Cohesion: 0.15
Nodes (31): indexLineRoomReceiptSearch(), buildReceiptSummaryText(), clamp01(), coerceMaybeJsonObject(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour() (+23 more)
...
Cohesion: 0.09
Nodes (48): handleStoreReceiptTextMessage(), startCorrectionSession(), buildReceiptDuplicateConfirmationFlexReply(), capText(), clearPendingReceiptDuplicate(), completePendingDuplicateAndReply(), conversationKey(), formatJapaneseReceiptDateFromIso() (+40 more)

### Community 48 - "Community 48"
Cohesion: 0.16
Nodes (27): normalizeInlineText(), normalizeReceiptFieldText(), alignReceiptStoreNameToRegistry(), findRegistryEntryForParsedStoreName(), normalizeStoreCompareKey(), receiptStoreNameMatchesRegistry(), resolveParsedStoreNameForDisplay(), StoreRegistryMatchCandidate (+19 more)
...
Cohesion: 0.14
Nodes (26): authenticate(), authenticateRawAdminToken(), exchangeChatJournalLoginLink(), exchangeChatMediaViewLink(), getStoredAdminTokenHash(), hashToken(), isInternalSupabaseServerKey(), isStoreLinkRequestAllowed() (+18 more)

### Community 54 - "Community 54"
Cohesion: 0.12
Nodes (25): buildFoodCourtWeeklyReportLink(), issueAdminDashboardLoginLinkToken(), MARUGOSECOND_LOCKDOWN_ALLOWED_ROOM_IDS, pushLineMessages(), pushLineMessagesToTarget(), pushLineText(), pushLineTextToTarget(), replyLineMessages() (+17 more)
...
Cohesion: 0.13
Nodes (25): buildJstMonthCreatedAtRange(), buildReceiptReportAggregateFromRows(), loadReceiptReportAggregateForRoom(), loadReceiptReportAggregateForStoreByReceiptDate(), loadReceiptRowsAnalyticsAligned(), normalizeConfiguredStorePartitionKey(), receiptDateIsoFromValue(), ReceiptReportAggregate (+17 more)
...
Cohesion: 0.10
Nodes (18): chat, migration, root, chat, chatSource, chatHtml, helpManual, migration (+10 more)
...
Cohesion: 0.13
Nodes (21): attachAliases(), findCatalogProductsByPriceRange(), findCatalogProductsByQuery(), findCatalogProductsByVintage(), findCurrentPricesByQuery(), getPriceDistance(), buildCatalogCandidatesMessage(), buildCatalogChoiceLine() (+13 more)
...
Cohesion: 0.14
Nodes (24): fetchManualMonthSalesMapForStore(), manualMonthSalesFromRow(), ManualMonthSalesRecord, ManualMonthSalesUpsertEntry, normalizeSheetIntegerInput(), normalizeUpdatedAtInput(), parseManualMonthOperatingDays(), parseManualMonthPartyGuestFromUnknown() (+16 more)
...
Cohesion: 0.20
Nodes (21): base64UrlEncodeBytes(), base64UrlEncodeText(), fetchGoogleServiceAccountAccessToken(), pemToArrayBuffer(), signRs256(), addSpreadsheetSheet(), appendSpreadsheetValues(), batchUpdateSpreadsheetValues() (+13 more)
...
Cohesion: 0.14
Nodes (17): ExtractedTokyoDomeEvent, isWeekdayLabel(), markerCategory(), normalizeBaseballCategory(), parseTokyoDomeSchedule(), DbClient, DOME_CITY_HALLS, DomeAiUsage (+9 more)

### Community 77 - "Community 77"
Cohesion: 0.11
Nodes (15): read(), root, read(), root, read(), read(), root, expectedStoreLogos (+7 more)
...
Cohesion: 0.21
Nodes (22): aggregatePosJournalReceiptPayments(), allocateDayPaymentsToSales(), allocateDayTaxToSales(), buildJournalSavedReportsFromPosDays(), buildPosJournalDaysFromSavedReports(), dateRangeLabel(), isRecord(), journalReportId() (+14 more)
...
Cohesion: 0.14
Nodes (26): archiveChatMedia(), authenticateChatMember(), decideChatMenuKnowledge(), handleChatRoomConfig(), handleChatRoomPurge(), handleChatScheduleEvent(), hasPdfMagicHeader(), hasZipMagicHeader() (+18 more)
...
Cohesion: 0.15
Nodes (16): sendLinePush(), buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken(), sendLinePush() (+8 more)
...
Cohesion: 0.13
Nodes (19): addIngestionError(), createIngestionFile(), createStore(), listReplyTemplates(), nowIso(), recordIngestionProductSnapshot(), resolveStoreId(), saveLineEvent() (+11 more)
...
Cohesion: 0.13
Nodes (16): ChatCardAction, ChatCardFieldRow, ChatCardListItem, ChatCardPayload, ChatCardSection, DbClient, dispatchChatPush(), resolveChatGroupId() (+8 more)
...
Cohesion: 0.26
Nodes (17): roundToScale(), toSafeString(), buildReviewExcerpt(), deactivateCompetitorPlace(), deactivateStoreReviewPlace(), ensureStoreReviewProfile(), fetchCompetitorReviewContext(), fetchGooglePlaceDetails() (+9 more)
...
Cohesion: 0.17
Nodes (16): buildDocumentStoragePath(), createPettyCashEntry(), createPettyCashEntryFromReceiptImage(), normalizePettyCashReceiptImageMime(), normalizePettyItems(), normalizePettyTaxMode(), PETTY_ACCT_KEYS, pettyCategoryLabel() (+8 more)
...
Cohesion: 0.31
Nodes (12): menuKnowledgeFromLineImageAnalysis(), asRecord(), assessKnowledgeMenuQuality(), buildStructuredKnowledgeMenuBody(), countKnowledgePriceMentions(), KnowledgeMenuItem, KnowledgeMenuQuality, normalizeKnowledgeMenuItems() (+4 more)
...
Cohesion: 0.27
Nodes (10): offerMenuKnowledgeRegistration(), ChatCard, boundedStrings(), buildMtalkMenuKnowledgeCard(), MtalkMenuKnowledgeAnalysis, MtalkMenuKnowledgeItem, MtalkMenuKnowledgeStatus, normalizeMtalkMenuKnowledgeAnalysis() (+2 more)
...
Cohesion: 0.22
Nodes (6): dailySalesTemplateUrl(), isDailySalesTemplateRequestText(), isDailySalesWorkbookName(), replyDailySalesTemplateDownload(), Inserted, makeStub()
...
Cohesion: 0.11
Nodes (24): getActiveReplyTemplateByKey(), renderTemplate(), saveOcrResult(), buildTextByTemplate(), clearLineSelectionState(), extractQueryCandidatesFromOcrText(), fetchLineImageBuffer(), formatCatalogPrimaryName() (+16 more)
...
## Knowledge Gaps
- **992 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+987 more)
...
- **Why does `row()` connect `Community 65` to `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 12`, `Community 19`, `Community 147`, `Community 153`, `Community 154`, `Community 157`, `Community 32`, `Community 39`, `Community 44`, `Community 56`, `Community 68`, `Community 72`, `Community 102`, `Community 125`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `roomHasStoreBot()` connect `Community 67` to `Community 152`, `Community 50`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `isStoreBot()` connect `Community 152` to `Community 34`, `Community 67`, `Community 239`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Are the 49 inferred relationships involving `row()` (e.g. with `renderSheetPreview()` and `loadQuotedMessages()`) actually correct?**
  _`row()` has 49 INFERRED edges - model-reasoned connections that need verification._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _992 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.01854123079142919 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.023168316831683168 - nodes in this community are weakly interconnected._