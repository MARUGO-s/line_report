...
Cohesion: 0.08
Nodes (37): appendChunkWithinLimit(), appendWordXmlNodeText(), buildLineUserPermissionPayload(), collectTextNodes(), columnNameToIndex(), compareWordXmlEntry(), compareXlsxWorksheetEntry(), decodeXmlEntities() (+29 more)
...
Cohesion: 0.15
Nodes (20): deleteStoreKnowledgeItem(), fetchManualMonthGross(), fetchManualMonthsForYearState(), fetchSalesBudgetRow(), fetchStorageUsageState(), fetchStoreClosedDatesFromTable(), importDailyReceiptsCommit(), listCalendarMonthsInclusive() (+12 more)
...
Cohesion: 0.18
Nodes (18): addReceiptToCohort(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), emptyCohortBucket(), filterFromProductSearchObject(), isWeekendBusinessDate(), itemMatchesPosProductFilter(), normalizeCohortComparisonSpec() (+10 more)
...
- **Why does `xlsx` connect `Community 90` to `Community 117`, `Community 84`, `Community 37`?**
  _High betweenness centrality (0.268) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 84` to `Community 1`, `Community 90`, `Community 17`?**
  _High betweenness centrality (0.266) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 117` to `Community 90`, `Community 3`?**
