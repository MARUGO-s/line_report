...
## Summary
- 3686 nodes · 8525 edges · 322 communities (188 shown, 134 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 194 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5ee40536`
...
## Communities (322 total, 134 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (57): afterUpdate(), As(), beforeDatasetDraw(), beforeDatasetsDraw(), beforeUpdate(), Bt(), _calculateBarIndexPixels(), d() (+49 more)
...
Cohesion: 0.05
Nodes (82): allergyLabel(), buildReservationRow(), buildTodayReservationCalendarUrl(), buildTodayReservationFlex(), DbClient, formatReservationCustomerName(), formatTargetMonth(), handleTestSend() (+74 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (87): buildAllFeaturesGuideFlex(), buildGroupSalesDatePromptFlex(), buildGroupSalesSearchGuideFlex(), buildGroupSalesSearchGuideText(), buildKindPromptFlex(), buildSearchEntryReply(), buildSearchMenuFlex(), buildSearchMenuFooter() (+79 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (19): addBox(), addElements(), afterDatasetsUpdate(), an(), configure(), fe(), generateLabels(), Ie() (+11 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (20): Ae(), afterDraw(), afterEvent(), ba, Bi(), f(), g(), ki() (+12 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (19): at(), buildTicks(), _calculateBarValuePixels(), Ci(), getBasePixel(), getLabelAndValue(), getLabelForValue(), go() (+11 more)
...
Cohesion: 0.05
Nodes (14): Be(), bo, ca(), determineDataLimits(), Do(), eo(), getValueForPixel(), ko (+6 more)
...
Cohesion: 0.06
Nodes (48): appendReceiptSheetsBackgroundSyncSummaryLog(), BudgetComparable, BudgetRow, buildDailySeriesForStoreMonth(), buildJstDateKeysForMonth(), buildJstMonthRange(), buildPastSalesSheetUpdatesFromDb(), compressClosedDaysToSegments() (+40 more)
...
Cohesion: 0.09
Nodes (38): buildDailySalesConfirmFlex(), buildDailySalesImportedFlex(), buildDailySalesSummaryRows(), buildDailySalesTemplateDownloadFlex(), buildReservationConfirmFlex(), buildReservationImportDetailJson(), buildReservationRegisteredFlex(), buildReservationUpdatedFlex() (+30 more)
...
Cohesion: 0.10
Nodes (38): fetchJapaneseHolidaySet(), getJapaneseHolidayDateSet(), fetchManualMonthSales(), buildFoodcourtReportUri(), buildComparableEndDateForMonth(), buildReceiptAnalyticsDashboardUrlForLine(), computeBudgetDiffs(), computeComparableMonthProgressRatio() (+30 more)

### Community 21 - "Community 21"
Cohesion: 0.12
Nodes (42): budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates(), buildBudgetSheetRowUpdatesFromDb(), buildClosedDatesExportFromDb(), buildClosedDatesSheetUpdates() (+34 more)
...
Cohesion: 0.09
Nodes (9): Cs, Ee(), Ft(), It(), Le(), nn(), os(), sn (+1 more)
...
Cohesion: 0.10
Nodes (10): bn(), ei(), je(), pn(), qe(), qs(), ti(), un() (+2 more)
...
Cohesion: 0.15
Nodes (26): indexLineRoomReceiptSearch(), buildReceiptSummaryText(), buildReceiptTextReply(), formatYenAmount(), isPlausibleReceiptCount(), looksLikeOcrLatinStoreLabel(), resolveCanonicalStoreDisplayName(), countFromRawOrDb() (+18 more)
...
Cohesion: 0.14
Nodes (29): applySauvageNetSalesAsGrossSales(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour(), formatJapaneseReceiptDateFromIso(), getJstBusinessDateForReceiptBudget() (+21 more)
...
Cohesion: 0.18
Nodes (21): authenticateAdminDashboardSessionToken(), base64UrlEncode(), constantTimeEqualHex(), exchangeAdminDashboardLoginLinkToken(), exchangeRoomConfigLoginLink(), generateOpaqueToken(), hashRoomConfigPassword(), hashToken() (+13 more)

### Community 51 - "Community 51"
Cohesion: 0.11
Nodes (6): color(), kt(), qt(), te(), wt(), zt()
...
Cohesion: 0.22
Nodes (17): fetchManualMonthSalesMapForStore(), manualMonthSalesFromRow(), ManualMonthSalesUpsertEntry, normalizeSheetIntegerInput(), normalizeUpdatedAtInput(), parseManualMonthOperatingDays(), parseManualMonthPartyGuestFromUnknown(), parseOptionalNonNegativeInt() (+9 more)
...
Cohesion: 0.40
Nodes (4): JOB_TITLE_OPTIONS, jobTitleSortRank(), LABEL_SET, RANK_BY_LABEL
...
- **Why does `xlsx` connect `Community 38` to `Community 74`, `Community 108`?**
  _High betweenness centrality (0.299) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 74` to `Community 17`, `Community 38`?**
  _High betweenness centrality (0.294) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 108` to `Community 2`, `Community 38`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.027668455575432318 - nodes in this community are weakly interconnected._
