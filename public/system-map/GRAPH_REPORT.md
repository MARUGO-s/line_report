...
## Summary
- 5685 nodes · 12286 edges · 543 communities (349 shown, 194 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 116 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad0b55c2`
...
Cohesion: 0.02
Nodes (126): addDaysIso(), AdminAuthenticationResult, AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, authenticate(), AuthenticatedAdmin (+118 more)
...
Cohesion: 0.04
Nodes (99): buildDailySalesConfirmFlex(), buildDailySalesImportedFlex(), buildDailySalesSummaryRows(), buildDailySalesTemplateDownloadFlex(), buildReservationConfirmFlex(), buildReservationImportDetailJson(), buildReservationRegisteredFlex(), buildReservationUpdatedFlex() (+91 more)
...
Cohesion: 0.06
Nodes (70): normalizeSheetIntegerInput(), applySheetMissingMonthDeletions(), BudgetComparable, budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, buildBudgetOperatingDaysSheetUpdates() (+62 more)
...
Cohesion: 0.07
Nodes (62): aggregatePosJournalReceiptPayments(), allocateDayPaymentsToSales(), allocateDayTaxToSales(), applyCachedWeatherToPosJournalDays(), applyPosJournalCategoryOverrides(), buildJournalSavedReportHtml(), buildJournalSavedReportsFromPosDays(), buildPosJournalCategoryRules() (+54 more)
...
Cohesion: 0.09
Nodes (50): coerceMaybeJsonObject(), normalizeInlineText(), normalizeLineImageAnalysisResult(), normalizeLineImageMenuAnalysis(), parseFirstJsonObject(), salvageLineImageAnalysisResultFromText(), buildMarugoGroupBuiltinPrompt(), buildMarugoSBuiltinPrompt() (+42 more)
...
Cohesion: 0.06
Nodes (48): buildClarificationMessages(), describeMissingKpiAssumptions(), ASSUMPTION_RULES, BASIS_RANK, buildDataGaps(), buildKpiScenarioPack(), clampField(), computeScenario() (+40 more)
...
Cohesion: 0.07
Nodes (40): appendChunkWithinLimit(), appendWordXmlNodeText(), buildDocumentSnippet(), collectTextNodes(), compareWordXmlEntry(), compareXlsxWorksheetEntry(), createSignedMediaDownloadUrl(), extractDocxText() (+32 more)
...
Cohesion: 0.10
Nodes (25): FoodCourtKpiContext, Loaders, prepareFoodCourtKpiScenario(), Profile, buildKpiScenarioReference(), isKpiScenarioRequest(), buildTrustedAiSalesData(), dateValid() (+17 more)

### Community 51 - "Community 51"
Cohesion: 0.15
Nodes (29): clearBistrocavacavaSheetDataRowsAndPushFromDb(), formatSheetA1Range(), appendSheetValuesForTab(), appendSyncLog(), buildDailySalesExportRows(), exportBudgetFromDbToBudgetSheet(), exportClosedDatesFromDbToBudgetSheet(), exportPastSalesFromDbToPastSheet() (+21 more)
...
Cohesion: 0.11
Nodes (24): attachJournalStoreContext(), loadJournalStoreContext(), number(), oneOf(), ProfileDatabase, ProfileResult, rebaseJournalWineAnalysis(), record() (+16 more)
...
Cohesion: 0.23
Nodes (19): parsePastSalesSheetRow(), budgetRowStoreKeyIndex(), buildClosedDatesSheetUpdates(), buildSheetDeletionMergeContext(), collectBudgetMonthsOnSheet(), collectDailyDatesOnSheet(), collectPastMonthsOnSheet(), fetchSheetTabMetaWatermark() (+11 more)
...
- **Why does `error()` connect `Community 154` to `Community 2`, `Community 3`, `Community 10`, `Community 139`, `Community 13`, `Community 141`, `Community 23`, `Community 161`, `Community 164`, `Community 37`, `Community 38`, `Community 43`, `Community 57`, `Community 59`, `Community 69`, `Community 74`, `Community 86`, `Community 88`, `Community 99`, `Community 106`, `Community 108`, `Community 111`, `Community 112`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 108` to `Community 0`, `Community 2`, `Community 71`, `Community 152`, `Community 154`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `generatePosJournalAiAnalysis()` connect `Community 23` to `Community 0`, `Community 154`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.01681436037264258 - nodes in this community are weakly interconnected._
