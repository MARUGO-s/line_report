...
## Summary
- 5660 nodes · 12460 edges · 541 communities (347 shown, 194 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 135 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a81c09d1`
...
Cohesion: 0.04
Nodes (114): buildSavedReportHtmlStoragePath(), buildStoreKnowledgeSearchText(), callKnowledgeGemini(), createSavedReportHtmlSignedUrl(), createSignedMediaUrl(), createStoreKnowledgeDownloadUrl(), decideChatMenuKnowledge(), deleteChatPdfHistoryItem() (+106 more)
...
Cohesion: 0.06
Nodes (78): allergyLabel(), buildReservationRow(), buildTodayReservationCalendarUrl(), buildTodayReservationChatCard(), buildTodayReservationChatText(), buildTodayReservationFlex(), DbClient, formatReservationCustomerName() (+70 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (81): BudgetComparable, budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates(), buildBudgetSheetRowUpdatesFromDb() (+73 more)
...
Cohesion: 0.09
Nodes (59): clamp01(), coerceMaybeJsonObject(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour(), formatJapaneseReceiptDateFromIso(), isSingleDayPeriodSettlementReport(), mergeReceiptConfidence() (+51 more)
...
Cohesion: 0.08
Nodes (56): replyLineFlex(), buildFlexInfoCard(), buildLineFlexBlueHeader(), flexButton(), FlexButtonAction, FlexButtonSpec, lineSafeFlexText(), ADMIN_MENU_POSTBACK (+48 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (51): archiveChatMedia(), authenticate(), authenticateChatMember(), authenticateRawAdminToken(), buildFoodCourtWeeklyReportLink(), exchangeChatJournalLoginLink(), exchangeChatMediaViewLink(), getStoredAdminTokenHash() (+43 more)
...
Cohesion: 0.08
Nodes (43): analyzePosJournalWithAi(), askPosJournalAi(), recordPosJournalAiUsage(), buildStoreLocationPromptBlock(), aggregatePeriod(), answerPosJournalAiQuestion(), boundedInteger(), boundedSignedInteger() (+35 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (49): createPettyCashEntryFromReceiptImage(), recordPettyCashWebAiUsage(), buildDailySalesConfirmFlex(), buildDailySalesImportedFlex(), buildDailySalesSummaryRows(), buildDailySalesTemplateDownloadFlex(), buildReservationConfirmFlex(), buildReservationImportDetailJson() (+41 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (45): AI_RATE_LIMITS, AiAction, boundedIsoDate(), boundedNonNegativeInteger(), boundJournalFoodcourtIntegrationReports(), BRIEF_CACHE_TTL_MS, buildClarificationMessages(), buildJournalAiServerPolicy() (+37 more)
...
Cohesion: 0.06
Nodes (48): loadWeatherForReports(), buildKpiScenarioContext(), ASSUMPTION_RULES, BASIS_RANK, buildDataGaps(), buildKpiScenarioPack(), buildKpiScenarioReference(), clampField() (+40 more)
...
Cohesion: 0.09
Nodes (38): sendLinePushMessages(), sendLinePush(), buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken() (+30 more)
...
Cohesion: 0.10
Nodes (37): getJapaneseHolidayDateSet(), fetchManualMonthSales(), ManualMonthSalesRecord, buildFoodcourtReportUri(), buildComparableEndDateForMonth(), computeBudgetDiffs(), computeComparableMonthProgressRatio(), DayAgg (+29 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (38): buildRelaxedGmailAlertQuery(), cleanupTestReservationSeed(), constantTimeEqual(), fetchGmailAccessTokenByRefreshToken(), filterUnnotifiedGmailMessageIds(), GmailAlertDeliveryBatch, GmailAlertEnv, GmailAlertEnvState (+30 more)

### Community 35 - "Community 35"
Cohesion: 0.10
Nodes (32): attachJournalStoreContext(), loadJournalStoreContext(), number(), oneOf(), ProfileDatabase, ProfileResult, rebaseJournalWineAnalysis(), record() (+24 more)
...
Cohesion: 0.07
Nodes (33): buildDocumentSnippet(), buildLineUserPermissionPayload(), clampInt(), createSignedMediaDownloadUrl(), fetchChatMediaView(), fetchDocumentPermissionSummaries(), fetchDocumentState(), fetchGlobalSettings() (+25 more)
...
Cohesion: 0.12
Nodes (27): fetchAnalyticsMonthly(), fetchReceiptDailyAggForRange(), date(), fetchManualMonthSalesMapForStore(), sanitizeReceiptCountFromDb(), loadReceiptReportAggregateForStoreByReceiptDate(), buildDailySeriesForStoreMonth(), fetchReceiptMonthlyAggregatesForStore() (+19 more)

### Community 51 - "Community 51"
Cohesion: 0.14
Nodes (28): CORS_HEADERS, DbClient, ensureManagerNoticeRoom(), filePayload(), handleDispatch(), handleSignupNotify(), handleSignupReviewed(), handleStoreChangeNotify() (+20 more)
...
Cohesion: 0.10
Nodes (20): ChatAction, CORS_HEADERS, helpCard(), SearchKind, ChatCardAction, ChatCardFieldRow, ChatCardListItem, ChatCardPayload (+12 more)

### Community 56 - "Community 56"
Cohesion: 0.18
Nodes (27): dedupeSalesSearchRows(), executeSalesSearch(), buildReceiptChatCard(), buildReceiptFlexMessage(), field(), formatCountOrDash(), formatDecimalOrDash(), formatReceiptDateJa() (+19 more)
...
Cohesion: 0.18
Nodes (24): indexLineRoomReceiptSearch(), upsertManualDaySalesEntries(), buildReceiptSummaryText(), computeReceiptHeuristicConfidence(), getJstBusinessDateForReceiptBudget(), isPlausibleReceiptCount(), looksLikeOcrLatinStoreLabel(), parseCurrencyAmount() (+16 more)
...
Cohesion: 0.17
Nodes (18): ChatStoreBot, DbClient, handleStoreRoomReceiptCommand(), loadChatStoreBot(), loadStoreRegistryRow(), mtalkMediaMessageId(), preferMenuKnowledgeResult(), processStoreRoomImageLikeLine() (+10 more)
...
Cohesion: 0.23
Nodes (16): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), knowledgeUint8ToBase64(), normalizeStoreKnowledgeUploadMime(), menuKnowledgeFromLineImageAnalysis(), asRecord(), assessKnowledgeMenuQuality(), buildStructuredKnowledgeMenuBody() (+8 more)
...
Cohesion: 0.27
Nodes (14): manualMonthSalesFromRow(), ManualMonthSalesUpsertEntry, normalizeSheetIntegerInput(), normalizeUpdatedAtInput(), parseManualMonthOperatingDays(), parseManualMonthPartyGuestFromUnknown(), parseOptionalNonNegativeInt(), parsePastSalesSheetRow() (+6 more)
...
Cohesion: 0.22
Nodes (6): buildReservationCalendarUrlsForAlerts(), planGmailAlertDeliveryBatches(), resolveAlertStorePartitionKey(), buildReservationCalendarPageUrl(), normalizeMonth(), root
...
## Knowledge Gaps
- **1045 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+1040 more)
...
- **Why does `error()` connect `Community 66` to `Community 0`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 138`, `Community 11`, `Community 140`, `Community 13`, `Community 17`, `Community 23`, `Community 25`, `Community 160`, `Community 162`, `Community 165`, `Community 38`, `Community 43`, `Community 45`, `Community 179`, `Community 53`, `Community 54`, `Community 57`, `Community 59`, `Community 78`, `Community 82`, `Community 87`, `Community 92`, `Community 100`, `Community 105`, `Community 110`, `Community 111`, `Community 112`, `Community 123`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `roomHasStoreBot()` connect `Community 150` to `Community 118`, `Community 38`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 87` to `Community 0`, `Community 66`, `Community 75`, `Community 18`, `Community 149`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.017832975081601782 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.040987424312994875 - nodes in this community are weakly interconnected._