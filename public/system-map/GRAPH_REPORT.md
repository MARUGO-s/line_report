...
## Summary
- 5061 nodes · 11028 edges · 500 communities (315 shown, 185 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cceaec6a`
...
## Communities (500 total, 185 thin omitted)
...
Cohesion: 0.06
Nodes (71): buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup(), buildReservationSummaryLookup(), buildSavedReportHtmlStoragePath(), chooseLaterIso(), chunkArray(), createSavedReportHtmlSignedUrl(), deleteChatPdfHistoryItem() (+63 more)
...
Cohesion: 0.09
Nodes (43): assertReservationEventMatchesStoreScope(), buildCalendarVisitMonthLabel(), buildCalendarVisitTimeLabel(), buildChatScheduleReservationDetail(), buildJstMonthRange(), buildReservationCalendarItem(), buildReservationNameSearchPatterns(), createManualReservationEvent() (+35 more)
...
Cohesion: 0.08
Nodes (39): addReceiptToCohort(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), emptyCohortBucket(), fetchChatPdfHistoryItem(), fetchChatPdfHistoryList(), fetchReportAiHistoryList(), fetchSalesForecastItem() (+31 more)
...
Cohesion: 0.06
Nodes (38): buildDocumentSnippet(), buildLineUserPermissionPayload(), clampInt(), createSignedMediaDownloadUrl(), createSignedMediaUrl(), fetchChatMediaView(), fetchDocumentPermissionSummaries(), fetchDocumentState() (+30 more)
...
Cohesion: 0.12
Nodes (30): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), buildStoreKnowledgeSearchText(), createStoreKnowledgeDownloadUrl(), deleteStoreKnowledgeItem(), fetchStoreKnowledgeItem(), fetchStoreKnowledgeItems(), fetchStoreKnowledgeList() (+22 more)
...
Cohesion: 0.12
Nodes (39): indexLineRoomReceiptSearch(), normalizeReceiptCorrectionInputValue(), buildReceiptSummaryText(), buildReceiptTextReply(), clamp01(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour() (+31 more)
...
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 3` to `Community 0`, `Community 28`, `Community 20`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `xlsx` connect `Community 20` to `Community 3`, `Community 159`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 159` to `Community 2`, `Community 20`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _906 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.01812478215406065 - nodes in this community are weakly interconnected._
