...
## Summary
- 3968 nodes · 9402 edges · 331 communities (202 shown, 129 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 198 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `88388291`
...
## Communities (331 total, 129 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (42): As(), beforeDatasetDraw(), beforeDatasetsDraw(), beforeLayout(), configure(), d(), destroy(), Di() (+34 more)
...
Cohesion: 0.06
Nodes (70): a(), aa(), ai(), ao(), at(), average(), b(), beforeDraw() (+62 more)
...
Cohesion: 0.08
Nodes (18): afterDraw(), afterEvent(), afterUpdate(), ba, Ee(), f(), gs(), ki() (+10 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (64): asAppError(), buildLineUserPermissionPayload(), buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup(), buildReservationSummaryLookup(), chooseLaterIso(), chunkArray(), deleteChatPdfHistoryItem() (+56 more)
...
Cohesion: 0.06
Nodes (14): buildLookupTable(), En, Fo(), _generate(), getDecimalForValue(), _getTimestampsForTable(), init(), initOffsets() (+6 more)
...
Cohesion: 0.06
Nodes (51): BudgetComparable, budgetComparableFromSheetRow(), BudgetRow, buildClosedDatesExportFromDb(), buildDailySeriesForStoreMonth(), buildJstDateKeysForMonth(), buildJstMonthRange(), closedOnToMonthDateIso() (+43 more)
...
Cohesion: 0.15
Nodes (34): budgetComparableEqual(), budgetComparableFromRow(), budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates(), buildBudgetSheetRowUpdatesFromDb(), buildClosedDatesSheetUpdates(), buildSheetDeletionMergeContext(), collectBudgetMonthsOnSheet() (+26 more)
...
Cohesion: 0.19
Nodes (18): countFromRawOrDb(), currencyFromRawOrDb(), deleteReceiptSearchIndexEntries(), deleteReceiptSearchIndexForDate(), deleteReceiptsForDateByLineMessageIds(), deleteReceiptsForDateExcludingLineMessageId(), deleteStoreReceiptById(), deleteStoreReceiptByLineMessageId() (+10 more)
...
Cohesion: 0.07
Nodes (19): bo, _calculateBarIndexPixels(), _calculateBarValuePixels(), determineDataLimits(), getBasePixel(), getLabelAndValue(), getLabelForValue(), getPixelForTick() (+11 more)
...
Cohesion: 0.14
Nodes (25): fetchManualMonthSales(), fetchManualMonthSalesMapForStore(), manualMonthSalesFromRow(), ManualMonthSalesRecord, ManualMonthSalesUpsertEntry, normalizeSheetIntegerInput(), normalizeUpdatedAtInput(), parseManualMonthOperatingDays() (+17 more)
...
Cohesion: 0.07
Nodes (14): Ae(), Bi(), bn(), Ci(), ei(), Fi(), je(), ls (+6 more)
...
Cohesion: 0.14
Nodes (33): indexLineRoomReceiptSearch(), applySauvageNetSalesAsGrossSales(), buildReceiptSummaryText(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences(), extractPartyGuestCountsFromText(), extractReceiptPrintedHour() (+25 more)
...
Cohesion: 0.18
Nodes (20): buildFoodcourtReportUri(), buildReceiptAnalyticsDashboardUri(), buildComparableEndDateForMonth(), buildReceiptAnalyticsDashboardUrlForLine(), computeComparableMonthProgressRatio(), DayAgg, dayOfMonthFromIso(), daysInMonth() (+12 more)

### Community 63 - "Community 63"
Cohesion: 0.18
Nodes (18): BUDGET_NOTICE_LINES, budgetConfirmFlex(), budgetDoneFlex(), budgetFlex(), CANCEL_WORDS, clearPending(), commitBudgetAndReply(), conversationKey() (+10 more)
...
Cohesion: 0.19
Nodes (15): analyzePosJournalWithAi(), askPosJournalAi(), fetchPosJournalAiHistory(), fetchPosJournalRows(), fetchPosJournalState(), normalizeYearMonth(), posJournalAiHistoryStoreAndMonth(), posJournalFileRow() (+7 more)
...
Cohesion: 0.16
Nodes (18): buildDocumentStoragePath(), buildPosJournalStoragePath(), createPettyCashEntry(), createPettyCashEntryFromReceiptImage(), extractFileExt(), normalizePettyCashReceiptImageMime(), normalizePettyItems(), normalizePettyTaxMode() (+10 more)
...
Cohesion: 0.33
Nodes (4): context, htmlPath, indexPath, reports
...
## Knowledge Gaps
- **603 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+598 more)
...
- **Why does `xlsx` connect `Community 39` to `Community 10`, `Community 91`?**
  _High betweenness centrality (0.305) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 10` to `Community 2`, `Community 39`?**
  _High betweenness centrality (0.301) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 91` to `Community 3`, `Community 39`?**
