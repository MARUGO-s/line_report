...
## Summary
- 3981 nodes · 9427 edges · 331 communities (202 shown, 129 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 198 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c10e61d`
...
Cohesion: 0.03
Nodes (42): Ae(), beforeDatasetDraw(), beforeDatasetsDraw(), bo, buildTicks(), d(), destroy(), determineDataLimits() (+34 more)
...
Cohesion: 0.05
Nodes (19): As(), at(), beforeUpdate(), bn(), ei(), go(), ii(), initialize() (+11 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (56): a(), aa(), ai(), ao(), average(), beforeDraw(), ca(), cn() (+48 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (18): addBox(), addElements(), afterDatasetsUpdate(), an(), configure(), generateLabels(), _i(), ke() (+10 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (19): afterDraw(), afterEvent(), afterUpdate(), ba, Bi(), Ee(), f(), gs() (+11 more)
...
Cohesion: 0.07
Nodes (23): b(), Be(), g(), H(), ha, j(), label(), m() (+15 more)
...
Cohesion: 0.09
Nodes (15): _calculateBarIndexPixels(), _calculateBarValuePixels(), getBasePixel(), getLabelAndValue(), getLabelForValue(), getPixelForValue(), _getRuler(), _getStackCount() (+7 more)
...
Cohesion: 0.15
Nodes (19): analyzePosJournalWithAi(), askPosJournalAi(), buildPosJournalStoragePath(), extractFileExt(), fetchPosJournalAiHistory(), fetchPosJournalRows(), fetchPosJournalState(), normalizePettyCashReceiptImageMime() (+11 more)
...
Cohesion: 0.21
Nodes (14): buildDocumentStoragePath(), createPettyCashEntry(), createPettyCashEntryFromReceiptImage(), normalizePettyItems(), normalizePettyTaxMode(), PETTY_ACCT_KEYS, pettyCategoryLabel(), pettyItemText() (+6 more)
...
- **Why does `xlsx` connect `Community 42` to `Community 69`, `Community 118`?**
  _High betweenness centrality (0.304) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 69` to `Community 17`, `Community 2`, `Community 42`?**
  _High betweenness centrality (0.300) - this node is a cross-community bridge._
- **Why does `parseExcelBuffer()` connect `Community 118` to `Community 42`, `Community 3`?**
