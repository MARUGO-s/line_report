...
## Summary
- 5702 nodes · 12500 edges · 536 communities (341 shown, 195 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 77 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `51b42f1e`
...
6. `answerFoodCourtQuestion()` - 33 edges
7. `handleDispatch()` - 33 edges
8. `generateFoodCourtDailySummary()` - 31 edges
9. `generateFoodCourtPeriodSummary()` - 31 edges
10. `processPullRowsToDb()` - 31 edges
...
- `normalizeWineAnalysisResult()` --indirect_call--> `score()`  [INFERRED]
  src/server.js → supabase/functions/_shared/foodcourt_forecast_engine.ts
- `normalizeWineAnalysisResult()` --indirect_call--> `number()`  [INFERRED]
  src/server.js → supabase/functions/_shared/journal_store_context.ts
...
## Communities (536 total, 195 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (150): addDaysIso(), AdminAuthenticationResult, AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, applyChatAdminTemplate(), assertChatAdminAuditScope() (+142 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (74): buildPosJournalRepairPayload(), buildPosJournalStoragePath(), buildSavedReportHtmlStoragePath(), createSavedReportHtmlSignedUrl(), deletePosJournalFile(), ensureJournalProductIndexMonths(), ensurePosJournalStorageForRepair(), extractFileExt() (+66 more)
...
Cohesion: 0.06
Nodes (94): appendReservationHonorific(), buildDisplayWidthIndent(), buildGmailReservationAlertLinePayload(), buildGmailReservationAlertMessage(), buildGmailReservationChatCards(), buildGmailReservationFlexAltText(), buildGmailReservationFlexBubble(), buildGmailReservationFlexMessage() (+86 more)
...
Cohesion: 0.04
Nodes (78): foodCourtExceptionReason(), FoodCourtExtractionDiagnostic, foodCourtGeminiGeneration(), foodCourtGeminiText(), foodCourtImageMime(), FoodCourtProvider, foodCourtProviderTimeout(), foodCourtRoleProvider() (+70 more)
...
Cohesion: 0.09
Nodes (45): archiveChatMedia(), asAppError(), authenticate(), authenticateChatMember(), buildFoodCourtWeeklyReportLink(), decideChatMenuKnowledge(), exchangeChatJournalLoginLink(), exchangeChatMediaViewLink() (+37 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (43): AI_RATE_LIMITS, AiAction, boundedIsoDate(), boundedNonNegativeInteger(), boundJournalFoodcourtIntegrationReports(), BRIEF_CACHE_TTL_MS, buildClarificationMessages(), buildJournalAiServerPolicy() (+35 more)
...
Cohesion: 0.07
Nodes (48): createPettyCashEntryFromReceiptImage(), recordPettyCashWebAiUsage(), buildDailySalesConfirmFlex(), buildDailySalesImportedFlex(), buildDailySalesSummaryRows(), buildDailySalesTemplateDownloadFlex(), buildReservationConfirmFlex(), buildReservationImportDetailJson() (+40 more)

### Community 18 - "Community 18"
Cohesion: 0.10
Nodes (49): indexLineRoomReceiptSearch(), normalizeReceiptCorrectionInputValue(), startCorrectionSession(), buildReceiptSummaryText(), buildReceiptTextReply(), clamp01(), computeReceiptHeuristicConfidence(), decodeEscapedUnicodeSequences() (+41 more)
...
Cohesion: 0.06
Nodes (47): fetchPosJournalCategoryRules(), amount(), buildJournalSavedReportHtml(), buildPosJournalCategoryRules(), classifyPosJournalDrinkSubclassByName(), classifyPosJournalReportItem(), CodeSpec, codeSpecMatches() (+39 more)

### Community 21 - "Community 21"
Cohesion: 0.15
Nodes (49): answerFoodCourtQuestion(), appendLoopFeedback(), buildAnomalyDays(), buildBaseInsights(), buildCompetitorContext(), buildConditionPatternStats(), buildContributionDecomposition(), buildDailyLogImpactContext() (+41 more)

### Community 22 - "Community 22"
Cohesion: 0.08
Nodes (44): buildHardcodedHolidayMap(), fetchCaoHolidayMap(), fetchJapaneseHolidayMap(), fetchJapaneseHolidaySet(), getJapaneseHolidayDateSet(), HolidayLiveCache, JAPANESE_HOLIDAY_ISO_DATES, JapaneseHolidaySource (+36 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (50): addReceiptToCohort(), buildJournalProductIndexMonthSnapshot(), combineJournalProductDetailCoverage(), comparePosJournalCohortsGeneral(), comparePosJournalProductCohorts(), emptyCohortBucket(), fetchChatPdfHistoryItem(), fetchChatPdfHistoryList() (+42 more)
...
Cohesion: 0.10
Nodes (40): fetchDistinctRoomIdsFromRawTable(), fetchManualMonthsForYearState(), fetchReceiptDailyAggForRange(), fetchReceiptSalesState(), fetchReceiptStoreOptions(), fetchReceiptWebhookStatus(), fetchSalesBudgetRow(), fetchStoreClosedDatesFromTable() (+32 more)

### Community 26 - "Community 26"
Cohesion: 0.13
Nodes (38): budgetComparableEqual(), budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates(), buildBudgetSheetRowUpdatesFromDb(), buildClosedDatesSheetUpdates(), buildPastSalesSheetUpdatesFromDb(), buildSheetDeletionMergeContext(), collectBudgetMonthsOnSheet() (+30 more)
...
Cohesion: 0.07
Nodes (42): loadWeatherForReports(), allocateUnits(), ASSUMPTION_RULES, BASIS_RANK, buildDataGaps(), buildKpiScenarioPack(), computeScenario(), emptyKpiBaseline() (+34 more)
...
Cohesion: 0.08
Nodes (38): purgeChatAdminRoom(), sendLinePushMessages(), sendLinePush(), buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken() (+30 more)
...
Cohesion: 0.06
Nodes (46): date(), appendReceiptSheetsBackgroundSyncSummaryLog(), BudgetComparable, BudgetRow, buildClosedDatesExportFromDb(), buildDailySeriesForStoreMonth(), buildJstDateKeysForMonth(), closedOnToMonthDateIso() (+38 more)
...
Cohesion: 0.11
Nodes (36): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), knowledgeUint8ToBase64(), ChatStoreBot, DbClient, handleStoreRoomReceiptCommand(), loadChatStoreBot(), loadStoreRegistryRow() (+28 more)
...
Cohesion: 0.12
Nodes (31): fetchAnalyticsMonthly(), fetchManualDayBudgetMapForStore(), fetchManualDaySalesMapForStore(), manualDaySalesFromRow(), ManualDaySalesRecord, ManualDaySalesUpsertEntry, normalizeDateInput(), parseOptionalNonNegativeInt() (+23 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (33): @electric-sql/pglite, devDependencies, @electric-sql/pglite, name, private, scripts, check, dev (+25 more)
...
Cohesion: 0.08
Nodes (33): appendChunkWithinLimit(), appendWordXmlNodeText(), collectTextNodes(), columnNameToIndex(), compareWordXmlEntry(), compareXlsxWorksheetEntry(), decodeXmlEntities(), extractDocxText() (+25 more)

### Community 51 - "Community 51"
Cohesion: 0.08
Nodes (32): buildDocumentSnippet(), clampInt(), createSignedMediaDownloadUrl(), createSignedMediaUrl(), fetchChatMediaView(), fetchDocumentPermissionSummaries(), fetchDocumentState(), fetchGlobalSettings() (+24 more)
...
Cohesion: 0.14
Nodes (25): attachJournalStoreContext(), loadJournalStoreContext(), number(), oneOf(), ProfileDatabase, ProfileResult, rebaseJournalWineAnalysis(), record() (+17 more)
...
Cohesion: 0.16
Nodes (26): buildReceiptReportAggregateFromRows(), normalizeConfiguredStorePartitionKey(), receiptDateIsoFromValue(), ReceiptReportAggregate, resolveStorePartitionKeyForRoom(), toReceiptStorePartitionKey(), alignReceiptStoreNameToRegistry(), resolveParsedStoreNameForDisplay() (+18 more)
...
Cohesion: 0.10
Nodes (19): updateChatMenuKnowledgeCard(), offerMenuKnowledgeRegistration(), ChatCard, boundedStrings(), buildMtalkMenuKnowledgeCard(), MtalkMenuKnowledgeAnalysis, MtalkMenuKnowledgeItem, MtalkMenuKnowledgeStatus (+11 more)
...
Cohesion: 0.18
Nodes (20): postChatCard(), postStoreRoomLineStyleReply(), fetchManualMonthSales(), applyImport(), BotUser, dailySalesTemplateUrl(), DbClient, handleMtalkDailySalesCommand() (+12 more)

### Community 76 - "Community 76"
Cohesion: 0.11
Nodes (26): buildKpiScenarioContext(), isRecord(), resolveKpiAssumptionValues(), buildFoodCourtKpiInputs(), FoodCourtKpiContext, FoodCourtKpiInputs, Loaders, prepareFoodCourtKpiScenario() (+18 more)

### Community 77 - "Community 77"
Cohesion: 0.14
Nodes (19): addName(), collectNames(), collectNamesFromText(), isRecord(), JournalAiPrivacyInput, JournalAiPrivacyResult, journalReservationAlias(), JsonRecord (+11 more)
...
Cohesion: 0.19
Nodes (20): normalizeReceiptFieldText(), findRegistryEntryForParsedStoreName(), normalizeStoreCompareKey(), receiptStoreNameMatchesRegistry(), StoreRegistryMatchCandidate, buildStoreReceiptPhoneIndex(), extractJapanesePhoneFromText(), listStorePhonesForPartitionKey() (+12 more)
...
Cohesion: 0.12
Nodes (20): collectGmailBodyParts(), countReservationCoreFields(), decodeBase64UrlUtf8(), extractGmailBodyText(), extractGmailHeader(), extractReservationMailDetailsWithGroq(), fetchGmailMessageAlert(), hasAnyReservationMailDetails() (+12 more)
...
Cohesion: 0.11
Nodes (21): buildRelaxedGmailAlertQuery(), cleanupTestReservationSeed(), fetchGmailAccessTokenByRefreshToken(), filterUnnotifiedGmailMessageIds(), json(), listGmailMessages(), loadGmailAlertEnv(), markGmailAlertRoomSent() (+13 more)
...
Cohesion: 0.15
Nodes (10): constantTimeEqual(), isGmailAlertTestAuthorized(), CORS_HEADERS, constantTimeEqualSecret(), CronAuthRpcClient, extractBearerToken(), InternalCronAuthOptions, isInternalCronAuthorized() (+2 more)
...
Cohesion: 0.18
Nodes (12): replyLineMessages(), resolveChannelAccessToken(), buildReservationCalendarPageUrl(), normalizeMonth(), buildReservationCalendarLinkFlex(), handleReservationCalendarLinkTextMessage(), TRIGGER_WORDS, buildRoomConfigUri() (+4 more)

### Community 95 - "Community 95"
Cohesion: 0.16
Nodes (17): better-sqlite3, dotenv, express, dependencies, better-sqlite3, dotenv, express, xlsx (+9 more)
...
Cohesion: 0.14
Nodes (8): resolveGroqTextModel(), RETIRED_GROQ_TEXT_MODELS, executable, png, source, table, input, stored
...
Cohesion: 0.26
Nodes (16): buildJstDateStartUtcIso(), buildReceiptReportTestSchedule(), buildScheduleSliceForKind(), constantTimeEqual(), dispatchReceiptReport(), getJstMonthLastDay(), handleReceiptReportTestSend(), json() (+8 more)
...
Cohesion: 0.06
Nodes (59): buildStoreKnowledgeSearchText(), callKnowledgeGemini(), chunkArray(), createStoreKnowledgeDownloadUrl(), deleteChatPdfHistoryItem(), deleteDocumentById(), deleteMediaItemById(), deleteReportAiHistoryItem() (+51 more)
...
## Knowledge Gaps
- **1057 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+1052 more)
...
- **Why does `xlsx` connect `Community 95` to `Community 90`, `Community 172`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `parseMonthlyDailySalesWorkbook()` connect `Community 90` to `Community 0`, `Community 17`, `Community 75`, `Community 95`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `normalizeWineAnalysisResult()` connect `Community 40` to `Community 4`, `Community 38`, `Community 103`, `Community 52`, `Community 55`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _1057 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.017372621240024554 - nodes in this community are weakly interconnected._
