...
## Summary
- 5555 nodes · 12267 edges · 532 communities (339 shown, 193 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 170 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1953a560`
...
6. `row()` - 49 edges
7. `toNonNegativeInteger()` - 37 edges
8. `handleDispatch()` - 33 edges
9. `answerFoodCourtQuestion()` - 32 edges
10. `generateFoodCourtDailySummary()` - 31 edges
...
## Communities (532 total, 193 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (130): addDaysIso(), AdminAuthenticationResult, AI_USAGE_CLAUDE_STORE_KEYS, AiUsageProviderBucket, AiUsageStoreRow, AppError, AuthenticatedAdmin, authenticateRawAdminToken() (+122 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (112): analyzeStoreKnowledgeImage(), buildKnowledgeBodyFallback(), buildSavedReportHtmlStoragePath(), buildStoreKnowledgeSearchText(), callKnowledgeGemini(), createSavedReportHtmlSignedUrl(), createStoreKnowledgeDownloadUrl(), deleteChatPdfHistoryItem() (+104 more)
...
Cohesion: 0.04
Nodes (86): fetchReceiptDailyAggForRange(), foodCourtExceptionReason(), FoodCourtExtractionDiagnostic, foodCourtGeminiGeneration(), foodCourtGeminiText(), foodCourtImageMime(), FoodCourtProvider, foodCourtProviderTimeout() (+78 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (85): createPettyCashEntryFromReceiptImage(), processReceiptImageEvent(), ChatStoreBot, DbClient, menuKnowledgeFromLineImageAnalysis(), mtalkMediaMessageId(), preferMenuKnowledgeResult(), processStoreRoomImageLikeLine() (+77 more)
...
Cohesion: 0.04
Nodes (67): backupDatabaseTo(), getAdminTokenOverride(), app, asBackupTimestamp(), buildCatalogDetailLines(), buildCustomHeaderMap(), buildMarketPriceFromHints(), buildSearchQueryVariants() (+59 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (62): buildDailySalesConfirmFlex(), buildDailySalesImportedFlex(), buildDailySalesSummaryRows(), buildDailySalesTemplateDownloadFlex(), buildReservationConfirmFlex(), buildReservationImportDetailJson(), buildReservationRegisteredFlex(), buildReservationUpdatedFlex() (+54 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (66): replyLineFlex(), ensureLineRoomDisplayNameFromWebhook(), ensureLineUserDisplayNameFromWebhook(), fetchLineConversationNameByRoomId(), fetchLineConversationNameByUrl(), fetchLineDisplayNameByUrl(), fetchLineDisplayNameByUserId(), isAutoDisplayNamesEnabled() (+58 more)
...
Cohesion: 0.06
Nodes (60): BudgetComparable, budgetComparableEqual(), budgetComparableFromRow(), budgetComparableFromSheetRow(), BudgetRow, buildClosedDatesExportFromDb(), buildDailySalesExportRows(), buildDailySeriesForStoreMonth() (+52 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (59): assertReservationEventMatchesStoreScope(), buildCalendarVisitMonthLabel(), buildCalendarVisitTimeLabel(), buildChatScheduleReservationDetail(), buildJstMonthRange(), buildReservationCalendarItem(), buildReservationCountDedupeKey(), buildReservationEffectiveSummaryLookup() (+51 more)
...
Cohesion: 0.07
Nodes (54): attachAliases(), findCatalogProductsByPriceRange(), findCatalogProductsByQuery(), findCatalogProductsByVintage(), getPriceDistance(), searchCatalogMatchesByQuery(), addReceiptToCohort(), buildJournalProductIndexMonthSnapshot() (+46 more)
...
Cohesion: 0.10
Nodes (43): archiveChatMedia(), authenticate(), authenticateChatMember(), buildFoodCourtWeeklyReportLink(), decideChatMenuKnowledge(), exchangeChatJournalLoginLink(), exchangeChatMediaViewLink(), handleChatRoomConfig() (+35 more)

### Community 23 - "Community 23"
Cohesion: 0.10
Nodes (47): fetchJapaneseHolidaySet(), dedupeSalesSearchRows(), executeSalesSearch(), buildReceiptChatCard(), buildReceiptFlexMessage(), field(), formatCountOrDash(), formatDecimalOrDash() (+39 more)
...
Cohesion: 0.09
Nodes (37): BUDGET_NOTICE_LINES, budgetConfirmFlex(), budgetDoneFlex(), budgetFlex(), CANCEL_WORDS, clearPending(), commitBudgetAndReply(), conversationKey() (+29 more)
...
Cohesion: 0.07
Nodes (16): ChatAction, CORS_HEADERS, helpCard(), SearchKind, ChatCardSection, emitFlexNote(), flexColor(), FlexField (+8 more)
...
Cohesion: 0.12
Nodes (35): importDailyReceiptsCommit(), parseManualDaySalesImport(), handleDailySalesImportPostback(), postChatCard(), postStoreRoomLineStyleReply(), clearDailyReceiptsForMonth(), countExistingReceiptsForDates(), DailySalesImportEntry (+27 more)
...
Cohesion: 0.08
Nodes (23): CORS_HEADERS, constantTimeEqualSecret(), CronAuthRpcClient, extractBearerToken(), InternalCronAuthOptions, isInternalCronAuthorized(), addDaysUtc(), buildWeeklyFlex() (+15 more)
...
Cohesion: 0.08
Nodes (27): assertIconFile(), captureInviteFromUrl(), captureRequestedGroup(), closeAccountMenu(), copyInvite(), currentRoomAllowsJournalAi(), currentRoomHasOnlyMeAndBots(), extractInviteToken() (+19 more)

### Community 42 - "Community 42"
Cohesion: 0.09
Nodes (35): asNullableWineField(), asSourceDisplayName(), buildGrapeCompositionFromEvidence(), buildJpyPriceRangeInfo(), buildLineWineReplyFallback(), buildSourceSummary(), buildWineAnalysisFallback(), buildWineSources() (+27 more)
...
Cohesion: 0.15
Nodes (33): budgetRowStoreKeyIndex(), buildBudgetOperatingDaysSheetUpdates(), buildBudgetSheetRowUpdatesFromDb(), buildClosedDatesSheetUpdates(), buildPastSalesSheetUpdatesFromDb(), buildSheetDeletionMergeContext(), collectBudgetMonthsOnSheet(), collectDailyDatesOnSheet() (+25 more)
...
Cohesion: 0.12
Nodes (25): fetchAnalyticsMonthly(), fetchManualDayBudgetMapForStore(), fetchManualDaySalesMapForStore(), manualDaySalesFromRow(), ManualDaySalesRecord, ManualDaySalesUpsertEntry, normalizeDateInput(), parseOptionalNonNegativeInt() (+17 more)

### Community 50 - "Community 50"
Cohesion: 0.14
Nodes (28): Accuracy, candidatePredictions(), dateDistance(), evaluationReport(), EVENTS, Feature, LedgerRow, mean() (+20 more)
...
Cohesion: 0.11
Nodes (26): buildHardcodedHolidayMap(), fetchCaoHolidayMap(), fetchJapaneseHolidayMap(), getJapaneseHolidayDateSet(), HolidayLiveCache, JAPANESE_HOLIDAY_ISO_DATES, JapaneseHolidaySource, mergeWithFutureFallback() (+18 more)
...
Cohesion: 0.15
Nodes (25): foodCourtFetch(), foodCourtHttpReason(), buildFoodCourtProviderOrder(), claudeChat(), claudeUsageFrom(), exceptionReason(), extractClaudeText(), foodCourtAiChat() (+17 more)
...
Cohesion: 0.15
Nodes (17): sendLinePushMessages(), sendLinePush(), buildAlertMessage(), DbClient, dowOf(), PvEvent, resolveStoreLineToken(), sanitizeLineToken() (+9 more)
...
Cohesion: 0.15
Nodes (16): ChatCard, ChatCardAction, ChatCardFieldRow, ChatCardListItem, ChatCardPayload, DbClient, dispatchChatPush(), resolveChatGroupId() (+8 more)
...
Cohesion: 0.14
Nodes (18): findCurrentPricesByQuery(), getActiveReplyTemplateByKey(), renderTemplate(), buildCatalogCandidatesMessage(), buildCatalogChoiceLine(), buildCurrentPriceLines(), buildNumberedCandidatesMessage(), buildPriceCandidatesMessage() (+10 more)
...
Cohesion: 0.18
Nodes (18): buildSearchSnippet(), closeUserInviteTarget(), directoryUsers(), escapeLikePattern(), handleTalkSearchInput(), inviteSelectedToGroup(), inviteSelectedToNewGroup(), isDirectoryUser() (+10 more)
...
Cohesion: 0.25
Nodes (12): RECEIPT_SHEETS_STORE_CATALOG, extractJapanesePhoneFromText(), listStorePhonesForPartitionKey(), normalizePhonesList(), normalizeReceiptPhoneDigits(), parseReceiptPhonesInput(), persistLearnedReceiptPhone(), phoneDigitsEqual() (+4 more)
...
Cohesion: 0.16
Nodes (17): applyRoomViewCache(), consumeInvite(), hideMemberStrip(), latestMessageFingerprint(), loadUnread(), markGroupRead(), mergeLatestPage(), openMessageAt() (+9 more)
...
## Knowledge Gaps
- **1009 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+1004 more)
...
- **Why does `error()` connect `Community 69` to `Community 0`, `Community 3`, `Community 6`, `Community 10`, `Community 11`, `Community 138`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 25`, `Community 153`, `Community 155`, `Community 158`, `Community 32`, `Community 33`, `Community 41`, `Community 171`, `Community 46`, `Community 52`, `Community 55`, `Community 57`, `Community 59`, `Community 60`, `Community 75`, `Community 81`, `Community 83`, `Community 88`, `Community 94`, `Community 107`, `Community 108`, `Community 116`, `Community 121`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `row()` connect `Community 16` to `Community 1`, `Community 2`, `Community 10`, `Community 13`, `Community 14`, `Community 15`, `Community 19`, `Community 158`, `Community 33`, `Community 162`, `Community 42`, `Community 46`, `Community 47`, `Community 50`, `Community 53`, `Community 71`, `Community 88`, `Community 103`, `Community 115`, `Community 123`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `roomHasStoreBot()` connect `Community 147` to `Community 41`, `Community 116`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Are the 64 inferred relationships involving `error()` (e.g. with `exchangeAdminTokenForSession()` and `decideMenuKnowledgeFromCard()`) actually correct?**
  _`error()` has 64 INFERRED edges - model-reasoned connections that need verification._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _1009 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.017701863354037266 - nodes in this community are weakly interconnected._
