...
const CHAT_ACCESS_COLUMNS = 'user_id, access_enabled, can_start_direct, can_create_group, can_browse_users, can_use_journal_ai, can_review_access, is_full_admin, default_can_send, signup_status, restriction_reason, restricted_until, deleted_at';
