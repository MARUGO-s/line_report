...
### 2026-08-23 - 青い余白をなくして入力欄を直下へ移動

- Correction: 空白をスクロールで埋めるのではなく、メッセージと入力欄の間にある青い領域そのものをなくしたい。
- Fix: スマホで最後のメッセージが見えている場合、メッセージ領域の高さをその下端まで縮め、固定入力欄を通常配置へ切り替えて直下へ移動する。
