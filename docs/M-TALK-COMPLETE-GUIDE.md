...
4. 許可／不許可カードはルーム管理権限を持つ人の1対1にだけ届く。店舗ルームの一般メンバーには見えない。許可されると申請した所属店舗が付き、閲覧のみで始まる。
...
- **新規登録は承認待ち。** 管理権限を持つ人が許可するまで使えず、許可後も閲覧のみで始まる。承認カードは管理者本人のトークにだけ届き、店舗ルームの一般メンバーには見えない。
