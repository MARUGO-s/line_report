...
|---|---|---|---|
| 専門AI 1 | 他店比較、時系列、要因分解、相関、異常値 | Groq / `llama-3.3-70b-versatile` | 数値統計、競合業態、予測、日報効果対照 |
...
| 統合AI | 最終回答の構成と矛盾解消 | 初回はOpenAI / `o4-mini` | 全専門メモ、反証、統計、RAG |
| 改善再生成 | 評価指摘を反映した改稿 | Groq優先 | 前回答全文と改善指示 |
