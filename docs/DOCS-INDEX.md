...
*最終更新: 2026-07-09（フードコートAI売上分析システム_総合解説.md を新規追加＝オーケストレーション・各AI強み・統計事前計算・Q&Aループ・蒸留・日報の重要性を単独1本に統合。2026-07-08: フードコート日報システム.md 新規。2026-07-07: フードコートAIループシステム全体解説.md。2026-06-15: ROOM-SELF-CONFIG-GUIDE.md。2026-06-14: SECURITY.md）*
