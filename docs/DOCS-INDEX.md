...
| [フードコートAI分析システム_設計解説.md](./フードコートAI分析システム_設計解説.md) | 開発・運用 | フードコートの5エージェントAI分析、予測モデル1本化、統計拡張、品質評価ループ（§3-3）、API使用料 |
| [フードコートAIループシステム全体解説.md](./フードコートAIループシステム全体解説.md) | 開発・運用 | **2つの自己改善ループの全体像** — 予測のモデル選択ループ（GLM vs 乗算・毎晩自動採用）＋AI回答の品質評価ループ（既定OFF・有効化手順つき） |
...
*最終更新: 2026-07-07（フードコートAIループシステム全体解説.md を新規追加＝モデル選択ループ＋品質評価ループの全体像。AI_LOOP_ENGINEERING_DESIGN.md・学習システム構造・来客予測モデル・売上分析設計書・競合店プロファイルを索引に追加。2026-06-15: ROOM-SELF-CONFIG-GUIDE.md 新規追加。2026-06-14: SECURITY.md 新規追加）*
