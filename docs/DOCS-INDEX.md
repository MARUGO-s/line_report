...
*最終更新: 2026-07-08（フードコート日報システム.md を新規追加＝日報ページ・API・動員数連携・Q&A分析組み込みの設計解説。フードコートAI分析システム_設計解説.md に §3-4「現場日報データのQ&A組み込み」を追記。2026-07-07: フードコートAIループシステム全体解説.md を新規追加＝モデル選択ループ＋品質評価ループの全体像。2026-06-15: ROOM-SELF-CONFIG-GUIDE.md 新規追加。2026-06-14: SECURITY.md 新規追加）*
